CREATE TABLE [dbo].[t_SpecD] (
  ...
  CONSTRAINT [pk_t_SpecD] PRIMARY KEY CLUSTERED ([ChID], [SrcPosID])
)
ON [PRIMARY]
GO
...
SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_t_SpecD] ON [t_SpecD]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_t_SpecD', N'Last', N'UPDATE'
GO
