CREATE TABLE [dbo].[r_Desks] (
  ...
  CONSTRAINT [pk_r_Desks] PRIMARY KEY CLUSTERED ([DeskCode])
)
ON [PRIMARY]
GO
...
CREATE UNIQUE INDEX [DeskName]
  ON [dbo].[r_Desks] ([DeskName])
  ON [PRIMARY]
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_Desks] ON [r_Desks]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_Desks', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_Desks] ON [r_Desks]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_Desks', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_Desks] ON [r_Desks]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_Desks', N'Last', N'DELETE'
GO