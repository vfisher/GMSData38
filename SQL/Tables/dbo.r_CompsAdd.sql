CREATE TABLE [dbo].[r_CompsAdd] (
  ...
  CONSTRAINT [_pk_r_CompsAdd] PRIMARY KEY CLUSTERED ([CompID], [CompAdd])
)
ON [PRIMARY]
GO

CREATE INDEX [CompAdd]
  ON [dbo].[r_CompsAdd] ([CompAdd])
  ON [PRIMARY]
GO

CREATE INDEX [CompID]
  ON [dbo].[r_CompsAdd] ([CompID])
  ON [PRIMARY]
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_CompsAdd.CompID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_CompsAdd.CompDefaultAdd'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_CompsAdd] ON [r_CompsAdd]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_CompsAdd', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_CompsAdd] ON [r_CompsAdd]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_CompsAdd', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_CompsAdd] ON [r_CompsAdd]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_CompsAdd', N'Last', N'DELETE'
GO