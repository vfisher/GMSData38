CREATE TABLE [dbo].[r_ServiceCompatibility] (
  ...
  CONSTRAINT [pk_r_ServiceCompatibility] PRIMARY KEY CLUSTERED ([SrvcID], [CompatibleServiceID])
)
ON [PRIMARY]
GO

CREATE INDEX [CompatibleServiceID]
  ON [dbo].[r_ServiceCompatibility] ([CompatibleServiceID])
  ON [PRIMARY]
GO

CREATE INDEX [SrvcID]
  ON [dbo].[r_ServiceCompatibility] ([SrvcID])
  ON [PRIMARY]
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_ServiceCompatibility] ON [r_ServiceCompatibility]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_ServiceCompatibility', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_ServiceCompatibility] ON [r_ServiceCompatibility]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_ServiceCompatibility', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_ServiceCompatibility] ON [r_ServiceCompatibility]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_ServiceCompatibility', N'Last', N'DELETE'
GO