CREATE TABLE [dbo].[r_LevyCR] (
  ...
  CONSTRAINT [pk_r_LevyCR] PRIMARY KEY CLUSTERED ([LevyID], [CashType], [TaxTypeID])
)
ON [PRIMARY]
GO
...
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_LevyCR] ON [r_LevyCR]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_LevyCR', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_LevyCR] ON [r_LevyCR]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_LevyCR', N'Last', N'UPDATE'
GO