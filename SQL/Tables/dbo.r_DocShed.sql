CREATE TABLE [dbo].[r_DocShed] (
  ...
  CONSTRAINT [pk_r_DocShed] PRIMARY KEY CLUSTERED ([DocShedCode])
)
ON [PRIMARY]
GO

CREATE INDEX [DocShedName]
  ON [dbo].[r_DocShed] ([DocShedName])
  ON [PRIMARY]
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_DocShed] ON [r_DocShed]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_DocShed', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_DocShed] ON [r_DocShed]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_DocShed', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_DocShed] ON [r_DocShed]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_DocShed', N'Last', N'DELETE'
GO