CREATE TABLE [dbo].[r_ScaleGrs] (
  ...
  CONSTRAINT [pk_r_ScaleGrs] PRIMARY KEY CLUSTERED ([ScaleGrID])
)
ON [PRIMARY]
GO

CREATE UNIQUE INDEX [ChID]
  ON [dbo].[r_ScaleGrs] ([ChID])
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [ScaleGrName]
  ON [dbo].[r_ScaleGrs] ([ScaleGrName])
  ON [PRIMARY]
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_ScaleGrs] ON [r_ScaleGrs]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_ScaleGrs', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_ScaleGrs] ON [r_ScaleGrs]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_ScaleGrs', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_ScaleGrs] ON [r_ScaleGrs]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_ScaleGrs', N'Last', N'DELETE'
GO