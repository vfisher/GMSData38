CREATE TABLE [dbo].[t_RetRoutes] (
  ...
  CONSTRAINT [pk_t_RetRoutes] PRIMARY KEY CLUSTERED ([ChID], [RouteID])
)
ON [PRIMARY]
GO

CREATE INDEX [RouteID]
  ON [dbo].[t_RetRoutes] ([RouteID])
  ON [PRIMARY]
GO
...
SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_t_RetRoutes] ON [t_RetRoutes]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_t_RetRoutes', N'Last', N'UPDATE'
GO
