CREATE TABLE [dbo].[z_DocLinks] (
  ...
  CONSTRAINT [pk_z_DocLinks] PRIMARY KEY CLUSTERED ([LinkID])
)
ON [PRIMARY]
GO

CREATE INDEX [DocLinkTypeID]
  ON [dbo].[z_DocLinks] ([DocLinkTypeID])
  ON [PRIMARY]
GO

CREATE INDEX [DocLinkTypeParents]
  ON [dbo].[z_DocLinks] ([DocLinkTypeID], [ParentDocCode], [ParentChID])
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [UniqueParent]
  ON [dbo].[z_DocLinks] ([ParentDocCode], [ParentChID], [ChildDocCode], [ChildChID])
  ON [PRIMARY]
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_z_DocLinks] ON [z_DocLinks]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_z_DocLinks', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_z_DocLinks] ON [z_DocLinks]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_z_DocLinks', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_z_DocLinks] ON [z_DocLinks]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_z_DocLinks', N'Last', N'DELETE'
GO