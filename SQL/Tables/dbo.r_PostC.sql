CREATE TABLE [dbo].[r_PostC] (
  ...
  CONSTRAINT [pk_r_PostC] PRIMARY KEY CLUSTERED ([PostCID])
)
ON [PRIMARY]
GO
...
CREATE UNIQUE INDEX [PostCName]
  ON [dbo].[r_PostC] ([PostCName])
  ON [PRIMARY]
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_PostC.ChID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_PostC.PostCID'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_PostC] ON [r_PostC]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_PostC', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_PostC] ON [r_PostC]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_PostC', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_PostC] ON [r_PostC]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_PostC', N'Last', N'DELETE'
GO