CREATE TABLE [dbo].[r_GVols] (
  ...
  CONSTRAINT [pk_r_GVols] PRIMARY KEY CLUSTERED ([GVolID])
)
ON [PRIMARY]
GO
...
CREATE UNIQUE INDEX [GVolName]
  ON [dbo].[r_GVols] ([GVolName])
  ON [PRIMARY]
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GVols.ChID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GVols.GVolID'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_GVols] ON [r_GVols]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_GVols', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_GVols] ON [r_GVols]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_GVols', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_GVols] ON [r_GVols]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_GVols', N'Last', N'DELETE'
GO