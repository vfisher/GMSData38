CREATE TABLE [dbo].[p_LeaveSched] (
  ...
  CONSTRAINT [pk_p_LeaveSched] PRIMARY KEY CLUSTERED ([OurID], [DocID])
)
ON [PRIMARY]
GO

CREATE INDEX [CodeID1]
  ON [dbo].[p_LeaveSched] ([CodeID1])
  ON [PRIMARY]
GO

CREATE INDEX [CodeID2]
  ON [dbo].[p_LeaveSched] ([CodeID2])
  ON [PRIMARY]
GO

CREATE INDEX [CodeID3]
  ON [dbo].[p_LeaveSched] ([CodeID3])
  ON [PRIMARY]
GO

CREATE INDEX [CodeID4]
  ON [dbo].[p_LeaveSched] ([CodeID4])
  ON [PRIMARY]
GO

CREATE INDEX [CodeID5]
  ON [dbo].[p_LeaveSched] ([CodeID5])
  ON [PRIMARY]
GO

CREATE INDEX [DocID]
  ON [dbo].[p_LeaveSched] ([DocID])
  ON [PRIMARY]
GO

CREATE INDEX [EmpID]
  ON [dbo].[p_LeaveSched] ([EmpID])
  ON [PRIMARY]
GO

CREATE INDEX [IntDocID]
  ON [dbo].[p_LeaveSched] ([IntDocID])
  ON [PRIMARY]
GO

CREATE INDEX [KursMC]
  ON [dbo].[p_LeaveSched] ([KursMC])
  ON [PRIMARY]
GO

CREATE INDEX [OurID]
  ON [dbo].[p_LeaveSched] ([OurID])
  ON [PRIMARY]
GO
...
SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_p_LeaveSched] ON [p_LeaveSched]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_p_LeaveSched', N'Last', N'UPDATE'
GO
