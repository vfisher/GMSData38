CREATE TABLE [dbo].[r_AssetH] (
  ...
  CONSTRAINT [pk_r_AssetH] PRIMARY KEY CLUSTERED ([AssID], [BDate])
)
ON [PRIMARY]
GO
...
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_AssetH] ON [r_AssetH]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_AssetH', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_AssetH] ON [r_AssetH]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_AssetH', N'Last', N'UPDATE'
GO