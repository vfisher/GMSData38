CREATE TABLE [dbo].[r_States] (
  ...
  CONSTRAINT [pk_r_States] PRIMARY KEY CLUSTERED ([StateCode])
)
ON [PRIMARY]
GO

CREATE UNIQUE INDEX [ChID]
  ON [dbo].[r_States] ([ChID])
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [StateName]
  ON [dbo].[r_States] ([StateName])
  ON [PRIMARY]
GO
...
SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_States] ON [r_States]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_States', N'Last', N'UPDATE'
GO
