CREATE TABLE [dbo].[r_Carrs] (
  ...
  CONSTRAINT [pk_r_Carrs] PRIMARY KEY CLUSTERED ([CarrID])
)
ON [PRIMARY]
GO

CREATE INDEX [AssID]
  ON [dbo].[r_Carrs] ([AssID])
  ON [PRIMARY]
GO

CREATE INDEX [CarrCID]
  ON [dbo].[r_Carrs] ([CarrCID])
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [CarrName]
  ON [dbo].[r_Carrs] ([CarrName])
  ON [PRIMARY]
GO
...
CREATE INDEX [ProdID]
  ON [dbo].[r_Carrs] ([ProdID])
  ON [PRIMARY]
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_Carrs.ChID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_Carrs.CarrID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_Carrs.AssID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_Carrs.ProdID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_Carrs.ExpNorm'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_Carrs.CarrCID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_Carrs.TechnMass'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_Carrs.Tonnage'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_Carrs] ON [r_Carrs]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_Carrs', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_Carrs] ON [r_Carrs]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_Carrs', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_Carrs] ON [r_Carrs]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_Carrs', N'Last', N'DELETE'
GO