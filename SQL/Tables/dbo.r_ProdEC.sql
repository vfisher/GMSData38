CREATE TABLE [dbo].[r_ProdEC] (
  ...
  CONSTRAINT [_pk_r_ProdEC] PRIMARY KEY CLUSTERED ([ProdID], [CompID], [ExtProdID])
)
ON [PRIMARY]
GO

CREATE INDEX [CompID]
  ON [dbo].[r_ProdEC] ([CompID])
  ON [PRIMARY]
GO

CREATE INDEX [ExtProdID]
  ON [dbo].[r_ProdEC] ([ExtProdID])
  ON [PRIMARY]
GO

CREATE INDEX [ProdID]
  ON [dbo].[r_ProdEC] ([ProdID])
  ON [PRIMARY]
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_ProdEC.ProdID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_ProdEC.CompID'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_ProdEC] ON [r_ProdEC]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_ProdEC', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_ProdEC] ON [r_ProdEC]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_ProdEC', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_ProdEC] ON [r_ProdEC]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_ProdEC', N'Last', N'DELETE'
GO