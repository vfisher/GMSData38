CREATE TABLE [dbo].[r_CompMG] (
  ...
  CONSTRAINT [_pk_r_CompMG] PRIMARY KEY CLUSTERED ([CGrID], [CompID])
)
ON [PRIMARY]
GO

CREATE INDEX [CGrID]
  ON [dbo].[r_CompMG] ([CGrID])
  ON [PRIMARY]
GO

CREATE INDEX [CompID]
  ON [dbo].[r_CompMG] ([CompID])
  ON [PRIMARY]
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_CompMG.CGrID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_CompMG.CompID'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_CompMG] ON [r_CompMG]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_CompMG', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_CompMG] ON [r_CompMG]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_CompMG', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_CompMG] ON [r_CompMG]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_CompMG', N'Last', N'DELETE'
GO