CREATE TABLE [dbo].[r_PersonPreferences] (
  ...
  CONSTRAINT [pk_r_PersonPreferences] PRIMARY KEY CLUSTERED ([PersonID], [ExecutorID], [SrvcID], [ResourceID])
)
ON [PRIMARY]
GO

CREATE INDEX [ExecutorID]
  ON [dbo].[r_PersonPreferences] ([ExecutorID])
  ON [PRIMARY]
GO

CREATE INDEX [PersonID]
  ON [dbo].[r_PersonPreferences] ([PersonID])
  ON [PRIMARY]
GO

CREATE INDEX [ResourceID]
  ON [dbo].[r_PersonPreferences] ([ResourceID])
  ON [PRIMARY]
GO

CREATE INDEX [SrvcID]
  ON [dbo].[r_PersonPreferences] ([SrvcID])
  ON [PRIMARY]
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_PersonPreferences] ON [r_PersonPreferences]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_PersonPreferences', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_PersonPreferences] ON [r_PersonPreferences]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_PersonPreferences', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_PersonPreferences] ON [r_PersonPreferences]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_PersonPreferences', N'Last', N'DELETE'
GO