CREATE TABLE [dbo].[r_WWeeks] (
  ...
  [IsInt] [bit] NOT NULL,
  CONSTRAINT [pk_r_WWeeks] PRIMARY KEY CLUSTERED ([WWeekTypeID])
)
ON [PRIMARY]
GO

CREATE UNIQUE INDEX [ChID]
  ON [dbo].[r_WWeeks] ([ChID])
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [WWeekName]
  ON [dbo].[r_WWeeks] ([WWeekName])
  ON [PRIMARY]
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_WWeeks.ChID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_WWeeks.WWeekTypeID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_WWeeks.IsInt'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_WWeeks] ON [r_WWeeks]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_WWeeks', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_WWeeks] ON [r_WWeeks]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_WWeeks', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_WWeeks] ON [r_WWeeks]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_WWeeks', N'Last', N'DELETE'
GO