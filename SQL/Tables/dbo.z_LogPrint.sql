CREATE TABLE [dbo].[z_LogPrint] (
  ...
  CONSTRAINT [pk_z_LogPrint] PRIMARY KEY CLUSTERED ([LogID])
)
ON [PRIMARY]
GO

ALTER TABLE [dbo].[z_LogPrint]
  ADD CONSTRAINT [FK_z_LogPrint_z_Docs] FOREIGN KEY ([DocCode]) REFERENCES [dbo].[z_Docs] ([DocCode]) ON DELETE CASCADE ON UPDATE CASCADE
GO