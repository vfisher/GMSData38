CREATE TABLE [dbo].[r_EmpMP] (
  ...
  CONSTRAINT [_pk_r_EmpMP] PRIMARY KEY CLUSTERED ([OurID], [EmpID], [SrcPosID])
)
ON [PRIMARY]
GO

CREATE INDEX [BDate]
  ON [dbo].[r_EmpMP] ([BDate])
  ON [PRIMARY]
GO

CREATE INDEX [EDate]
  ON [dbo].[r_EmpMP] ([EDate])
  ON [PRIMARY]
GO

CREATE INDEX [EmpID]
  ON [dbo].[r_EmpMP] ([EmpID])
  ON [PRIMARY]
GO

CREATE INDEX [OurID]
  ON [dbo].[r_EmpMP] ([OurID])
  ON [PRIMARY]
GO

CREATE INDEX [PrevID]
  ON [dbo].[r_EmpMP] ([PrevID])
  ON [PRIMARY]
GO

CREATE INDEX [r_EmpMOr_EmpMP]
  ON [dbo].[r_EmpMP] ([OurID], [EmpID])
  ON [PRIMARY]
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_EmpMP.OurID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_EmpMP.EmpID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_EmpMP.SrcPosID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_EmpMP.PrevID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_EmpMP.IsPensioner'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_EmpMP.IsInvalid'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_EmpMP.DisGroup'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_EmpMP] ON [r_EmpMP]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_EmpMP', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_EmpMP] ON [r_EmpMP]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_EmpMP', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_EmpMP] ON [r_EmpMP]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_EmpMP', N'Last', N'DELETE'
GO