CREATE TABLE [dbo].[r_MenuM] (
  ...
  CONSTRAINT [pk_r_MenuM] PRIMARY KEY CLUSTERED ([MenuID], [SrcPosID])
)
ON [PRIMARY]
GO

CREATE INDEX [SubmenuID]
  ON [dbo].[r_MenuM] ([SubmenuID])
  ON [PRIMARY]
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_MenuM] ON [r_MenuM]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_MenuM', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_MenuM] ON [r_MenuM]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_MenuM', N'Last', N'UPDATE'
GO