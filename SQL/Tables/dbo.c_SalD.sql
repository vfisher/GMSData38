CREATE TABLE [dbo].[c_SalD] (
  ...
  CONSTRAINT [_pk_c_SalD] PRIMARY KEY CLUSTERED ([ChID], [EmpID], [CurrID], [KursMC])
)
ON [PRIMARY]
GO
...
CREATE INDEX [KursCC]
  ON [dbo].[c_SalD] ([KursCC])
  ON [PRIMARY]
GO

CREATE INDEX [KursMC]
  ON [dbo].[c_SalD] ([KursMC])
  ON [PRIMARY]
GO

CREATE INDEX [MChargeCC]
  ON [dbo].[c_SalD] ([MChargeCC])
  ON [PRIMARY]
GO

CREATE INDEX [MChargeCC1]
  ON [dbo].[c_SalD] ([MChargeCC1])
  ON [PRIMARY]
GO

CREATE INDEX [MChargeCC2]
  ON [dbo].[c_SalD] ([MChargeCC2])
  ON [PRIMARY]
GO

CREATE INDEX [MoreCC]
  ON [dbo].[c_SalD] ([MoreCC])
  ON [PRIMARY]
GO

CREATE INDEX [MoreCC1]
  ON [dbo].[c_SalD] ([MoreCC1])
  ON [PRIMARY]
GO

CREATE INDEX [MoreCC2]
  ON [dbo].[c_SalD] ([MoreCC2])
  ON [PRIMARY]
GO
...
EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.c_SalD.ChID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.c_SalD.EmpID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.c_SalD.CurrID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.c_SalD.KursMC'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.c_SalD.KursCC'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.c_SalD.SickAC'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.c_SalD.HolidayAC'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.c_SalD.SurChargeAC'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.c_SalD.MChargeCC'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.c_SalD.MChargeCC1'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.c_SalD.MChargeCC2'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.c_SalD.AdvanceAC'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.c_SalD.CreditIn'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.c_SalD.CreditOut'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.c_SalD.MoreCC'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.c_SalD.MoreCC1'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.c_SalD.MoreCC2'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_c_SalD] ON [c_SalD]
FOR DELETE AS
...
/* Проверка открытого периода */
  ...
  IF (@ADate IS NOT NULL) 
    BEGIN
      SELECT @Err = FORMATMESSAGE('%s (%s):' + CHAR(13) + dbo.zf_Translate('Дата или одна из дат изменяемого документа меньше даты открытого периода %s для фирмы с кодом %s') ,dbo.zf_Translate('Начисление денег служащим (Данные)'), 'c_SalD', dbo.zf_DatetoStr(@ADate), CAST(@OurID as varchar(10)))
      RAISERROR (@Err, 18, 1)
      ROLLBACK TRAN
      RETURN
    END
  ...
  IF (@ADate IS NOT NULL) 
    BEGIN
      SELECT @Err = FORMATMESSAGE('%s (%s):' + CHAR(13) + dbo.zf_Translate('Дата или одна из дат изменяемого документа больше даты открытого периода %s для фирмы с кодом %s') ,dbo.zf_Translate('Начисление денег служащим (Данные)'), 'c_SalD', dbo.zf_DatetoStr(@ADate), CAST(@OurID as varchar(10)))
      RAISERROR (@Err, 18, 1)
      ROLLBACK TRAN
      RETURN
    END
...
/* Возможно ли редактирование документа */
  IF EXISTS(SELECT * FROM c_Sal a, deleted b WHERE (b.ChID = a.ChID) AND dbo.zf_CanChangeDoc(12016, a.ChID, a.StateCode) = 0)
    BEGIN
      ...
      SELECT @Err2 = FORMATMESSAGE(dbo.zf_Translate('Изменение документа ''%s'' в данном статусе запрещено.'), dbo.zf_Translate('Начисление денег служащим'))
      RAISERROR(@Err2, 18, 1)
      ROLLBACK TRAN
      RETURN
    END
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_c_SalD', N'Last', N'DELETE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_c_SalD] ON [c_SalD]
FOR UPDATE AS
...
/* Проверка открытого периода */
  ...
  IF (@ADate IS NOT NULL) 
    BEGIN
      SELECT @Err = FORMATMESSAGE('%s (%s):' + CHAR(13) + dbo.zf_Translate('Новая дата или одна из дат документа меньше даты открытого периода %s для фирмы с кодом %s') ,dbo.zf_Translate('Начисление денег служащим (Данные)'), 'c_SalD', dbo.zf_DatetoStr(@ADate), CAST(@OurID as varchar(10)))
      RAISERROR (@Err, 18, 1)
      ROLLBACK TRAN
      RETURN
    END
  ...
  IF (@ADate IS NOT NULL) 
    BEGIN
      SELECT @Err = FORMATMESSAGE('%s (%s):' + CHAR(13) + dbo.zf_Translate('Новая дата или одна из дат документа больше даты открытого периода %s для фирмы с кодом %s') ,dbo.zf_Translate('Начисление денег служащим (Данные)'), 'c_SalD', dbo.zf_DatetoStr(@ADate), CAST(@OurID as varchar(10)))
      RAISERROR (@Err, 18, 1)
      ROLLBACK TRAN
      RETURN
    END
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_c_SalD', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_c_SalD] ON [c_SalD]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_c_SalD', N'Last', N'INSERT'
GO
