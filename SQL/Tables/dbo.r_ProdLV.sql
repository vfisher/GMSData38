CREATE TABLE [dbo].[r_ProdLV] (
  [ProdID] [int] NOT NULL,
  [LevyID] [int] NOT NULL,
  CONSTRAINT [pk_r_ProdLV] PRIMARY KEY CLUSTERED ([ProdID], [LevyID])
)
ON [PRIMARY]
GO
...
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_ProdLV] ON [r_ProdLV]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_ProdLV', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_ProdLV] ON [r_ProdLV]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_ProdLV', N'Last', N'UPDATE'
GO