CREATE TABLE [dbo].[r_DCTypes] (
  ...
  CONSTRAINT [pk_r_DCTypes] PRIMARY KEY CLUSTERED ([DCTypeCode])
)
ON [PRIMARY]
GO

CREATE UNIQUE INDEX [ChID]
  ON [dbo].[r_DCTypes] ([ChID])
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [DCTypeName]
  ON [dbo].[r_DCTypes] ([DCTypeName])
  ON [PRIMARY]
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_DCTypes] ON [r_DCTypes]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_DCTypes', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_DCTypes] ON [r_DCTypes]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_DCTypes', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_DCTypes] ON [r_DCTypes]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_DCTypes', N'Last', N'DELETE'
GO