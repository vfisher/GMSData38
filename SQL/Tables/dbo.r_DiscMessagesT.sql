CREATE TABLE [dbo].[r_DiscMessagesT] (
  ...
  CONSTRAINT [pk_r_DiscMessagesT] PRIMARY KEY CLUSTERED ([DiscCode], [CTableCode])
)
ON [PRIMARY]
GO
...
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_DiscMessagesT] ON [r_DiscMessagesT]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_DiscMessagesT', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_DiscMessagesT] ON [r_DiscMessagesT]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_DiscMessagesT', N'Last', N'UPDATE'
GO