CREATE TABLE [dbo].[r_PersonResourcesBL] (
  ...
  CONSTRAINT [pk_r_PersonResourcesBL] PRIMARY KEY CLUSTERED ([PersonID], [ResourceID])
)
ON [PRIMARY]
GO

CREATE INDEX [PersonID]
  ON [dbo].[r_PersonResourcesBL] ([PersonID])
  ON [PRIMARY]
GO

CREATE INDEX [ResourceID]
  ON [dbo].[r_PersonResourcesBL] ([ResourceID])
  ON [PRIMARY]
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_PersonResourcesBL] ON [r_PersonResourcesBL]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_PersonResourcesBL', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_PersonResourcesBL] ON [r_PersonResourcesBL]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_PersonResourcesBL', N'Last', N'UPDATE'
GO