CREATE TABLE [dbo].[r_ExecutorServices] (
  ...
  CONSTRAINT [pk_r_ExecutorServices] PRIMARY KEY CLUSTERED ([ExecutorID], [SrvcID])
)
ON [PRIMARY]
GO

CREATE INDEX [ExecutorID]
  ON [dbo].[r_ExecutorServices] ([ExecutorID])
  ON [PRIMARY]
GO

CREATE INDEX [SrvcID]
  ON [dbo].[r_ExecutorServices] ([SrvcID])
  ON [PRIMARY]
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_ExecutorServices] ON [r_ExecutorServices]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_ExecutorServices', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_ExecutorServices] ON [r_ExecutorServices]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_ExecutorServices', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_ExecutorServices] ON [r_ExecutorServices]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_ExecutorServices', N'Last', N'DELETE'
GO