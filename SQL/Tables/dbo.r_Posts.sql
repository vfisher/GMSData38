CREATE TABLE [dbo].[r_Posts] (
  ...
  CONSTRAINT [pk_r_Posts] PRIMARY KEY CLUSTERED ([PostID])
)
ON [PRIMARY]
GO
...
CREATE INDEX [PostCID]
  ON [dbo].[r_Posts] ([PostCID])
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [PostName]
  ON [dbo].[r_Posts] ([PostName])
  ON [PRIMARY]
GO

CREATE INDEX [PostTypeID]
  ON [dbo].[r_Posts] ([PostTypeID])
  ON [PRIMARY]
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_Posts.ChID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_Posts.PostID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_Posts.PostCID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_Posts.SalaryType'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_Posts.PostTypeID'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_Posts] ON [r_Posts]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_Posts', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_Posts] ON [r_Posts]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_Posts', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_Posts] ON [r_Posts]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_Posts', N'Last', N'DELETE'
GO