CREATE TABLE [dbo].[r_Resources] (
  ...
  CONSTRAINT [pk_r_Resources] PRIMARY KEY CLUSTERED ([ResourceID])
)
ON [PRIMARY]
GO

CREATE UNIQUE INDEX [ChID]
  ON [dbo].[r_Resources] ([ChID])
  ON [PRIMARY]
GO

CREATE INDEX [ResourceName]
  ON [dbo].[r_Resources] ([ResourceName])
  ON [PRIMARY]
GO

CREATE INDEX [ResourceTypeID]
  ON [dbo].[r_Resources] ([ResourceTypeID])
  ON [PRIMARY]
GO

CREATE INDEX [StockID]
  ON [dbo].[r_Resources] ([StockID])
  ON [PRIMARY]
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_Resources] ON [r_Resources]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_Resources', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_Resources] ON [r_Resources]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_Resources', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_Resources] ON [r_Resources]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_Resources', N'Last', N'DELETE'
GO