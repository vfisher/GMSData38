CREATE TABLE [dbo].[r_TaxRegionRates] (
  ...
  CONSTRAINT [pk_r_TaxRegionRates] PRIMARY KEY CLUSTERED ([TaxRegionID], [SrcDate])
)
ON [PRIMARY]
GO
...
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_TaxRegionRates] ON [r_TaxRegionRates]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_TaxRegionRates', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_TaxRegionRates] ON [r_TaxRegionRates]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_TaxRegionRates', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_TaxRegionRates] ON [r_TaxRegionRates]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_TaxRegionRates', N'Last', N'DELETE'
GO