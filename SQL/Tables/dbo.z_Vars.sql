CREATE TABLE [dbo].[z_Vars] (
  ...
  [ObjectDef] [text] NULL,
  CONSTRAINT [_pk_z_Vars] PRIMARY KEY CLUSTERED ([VarName])
)
ON [PRIMARY]
...
GO
CREATE TRIGGER [dbo].[TRel1_Ins_z_Vars] ON [z_Vars]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_z_Vars', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_z_Vars] ON [z_Vars]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_z_Vars', N'Last', N'UPDATE'
GO

ALTER TABLE [dbo].[z_Vars]
  ADD CONSTRAINT [FK_z_Vars_z_Apps] FOREIGN KEY ([AppCode]) REFERENCES [dbo].[z_Apps] ([AppCode]) ON DELETE CASCADE ON UPDATE CASCADE
GO

ALTER TABLE [dbo].[z_Vars]
  ADD CONSTRAINT [FK_z_Vars_z_VarPages] FOREIGN KEY ([VarPageCode]) REFERENCES [dbo].[z_VarPages] ([VarPageCode]) ON DELETE CASCADE ON UPDATE CASCADE
GO