CREATE TABLE [dbo].[r_PostMC] (
  ...
  CONSTRAINT [_pk_r_PostMC] PRIMARY KEY CLUSTERED ([PostID], [EmpClass])
)
ON [PRIMARY]
GO

CREATE INDEX [EmpClass]
  ON [dbo].[r_PostMC] ([EmpClass])
  ON [PRIMARY]
GO

CREATE INDEX [PostID]
  ON [dbo].[r_PostMC] ([PostID])
  ON [PRIMARY]
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_PostMC.PostID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_PostMC.EmpClass'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_PostMC.ClassFactor'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_PostMC.ClassSalary'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_PostMC] ON [r_PostMC]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_PostMC', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_PostMC] ON [r_PostMC]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_PostMC', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_PostMC] ON [r_PostMC]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_PostMC', N'Last', N'DELETE'
GO