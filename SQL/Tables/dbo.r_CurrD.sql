CREATE TABLE [dbo].[r_CurrD] (
  ...
  CONSTRAINT [pk_r_CurrD] PRIMARY KEY CLUSTERED ([CurrID], [NomValue])
)
ON [PRIMARY]
...
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_CurrD] ON [r_CurrD]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_CurrD', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_CurrD] ON [r_CurrD]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_CurrD', N'Last', N'UPDATE'
GO