CREATE TABLE [dbo].[r_Candidates] (
  ...
  CONSTRAINT [pk_r_Candidates] PRIMARY KEY CLUSTERED ([CandidateID])
)
ON [PRIMARY]
GO
...
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_Candidates] ON [r_Candidates]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_Candidates', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_Candidates] ON [r_Candidates]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_Candidates', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_Candidates] ON [r_Candidates]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_Candidates', N'Last', N'DELETE'
GO