CREATE TABLE [dbo].[r_UniTypes] (
  ...
  CONSTRAINT [pk_r_UniTypes] PRIMARY KEY CLUSTERED ([RefTypeID])
)
ON [PRIMARY]
GO

CREATE UNIQUE INDEX [ChID]
  ON [dbo].[r_UniTypes] ([ChID])
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [RefTypeName]
  ON [dbo].[r_UniTypes] ([RefTypeName])
  ON [PRIMARY]
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_UniTypes] ON [r_UniTypes]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_UniTypes', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_UniTypes] ON [r_UniTypes]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_UniTypes', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_UniTypes] ON [r_UniTypes]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_UniTypes', N'Last', N'DELETE'
GO