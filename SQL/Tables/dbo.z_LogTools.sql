CREATE TABLE [dbo].[z_LogTools] (
  ...
  CONSTRAINT [pk_z_LogTools] PRIMARY KEY CLUSTERED ([ChID])
)
ON [PRIMARY]
GO

ALTER TABLE [dbo].[z_LogTools]
  ADD CONSTRAINT [FK_z_LogTools_z_ToolRep] FOREIGN KEY ([RepToolCode]) REFERENCES [dbo].[z_ToolRep] ([RepToolCode]) ON DELETE CASCADE ON UPDATE CASCADE
GO