CREATE TABLE [dbo].[p_EmpInLeavs] (
  ...
  CONSTRAINT [pk_p_EmpInLeavs] PRIMARY KEY CLUSTERED ([ChID], [BDate])
)
ON [PRIMARY]
GO
...
GO
CREATE TRIGGER [dbo].[TRel1_Ins_p_EmpInLeavs] ON [p_EmpInLeavs]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_p_EmpInLeavs', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_p_EmpInLeavs] ON [p_EmpInLeavs]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_p_EmpInLeavs', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_p_EmpInLeavs] ON [p_EmpInLeavs]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_p_EmpInLeavs', N'Last', N'DELETE'
GO