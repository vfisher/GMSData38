CREATE TABLE [dbo].[r_DeskG] (
  ...
  CONSTRAINT [pk_r_DeskG] PRIMARY KEY CLUSTERED ([DeskGCode])
)
ON [PRIMARY]
GO
...
CREATE UNIQUE INDEX [DeskGName]
  ON [dbo].[r_DeskG] ([DeskGName])
  ON [PRIMARY]
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_DeskG] ON [r_DeskG]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_DeskG', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_DeskG] ON [r_DeskG]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_DeskG', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_DeskG] ON [r_DeskG]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_DeskG', N'Last', N'DELETE'
GO