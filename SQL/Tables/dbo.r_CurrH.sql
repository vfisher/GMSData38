CREATE TABLE [dbo].[r_CurrH] (
  ...
  CONSTRAINT [_pk_r_CurrH] PRIMARY KEY CLUSTERED ([CurrID], [DocDate])
)
ON [PRIMARY]
GO

CREATE INDEX [CurrID]
  ON [dbo].[r_CurrH] ([CurrID])
  ON [PRIMARY]
GO

CREATE INDEX [DocDate]
  ON [dbo].[r_CurrH] ([DocDate])
  ON [PRIMARY]
GO

CREATE INDEX [KursCC]
  ON [dbo].[r_CurrH] ([KursCC])
  ON [PRIMARY]
GO

CREATE INDEX [KursMC]
  ON [dbo].[r_CurrH] ([KursMC])
  ON [PRIMARY]
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_CurrH.CurrID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_CurrH.KursMC'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_CurrH.KursCC'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_CurrH] ON [r_CurrH]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_CurrH', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_CurrH] ON [r_CurrH]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_CurrH', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_CurrH] ON [r_CurrH]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_CurrH', N'Last', N'DELETE'
GO