CREATE TABLE [dbo].[c_EmpExc] (
  ...
  CONSTRAINT [pk_c_EmpExc] PRIMARY KEY CLUSTERED ([ChID])
)
ON [PRIMARY]
GO

CREATE INDEX [AccountAC]
  ON [dbo].[c_EmpExc] ([AccountAC])
  ON [PRIMARY]
GO

CREATE INDEX [CodeID1]
  ON [dbo].[c_EmpExc] ([CodeID1])
  ON [PRIMARY]
GO

CREATE INDEX [CodeID2]
  ON [dbo].[c_EmpExc] ([CodeID2])
  ON [PRIMARY]
GO

CREATE INDEX [CodeID3]
  ON [dbo].[c_EmpExc] ([CodeID3])
  ON [PRIMARY]
GO

CREATE INDEX [CodeID4]
  ON [dbo].[c_EmpExc] ([CodeID4])
  ON [PRIMARY]
GO

CREATE INDEX [CodeID5]
  ON [dbo].[c_EmpExc] ([CodeID5])
  ON [PRIMARY]
GO

CREATE INDEX [CurrID]
  ON [dbo].[c_EmpExc] ([CurrID])
  ON [PRIMARY]
GO

CREATE INDEX [DocDate]
  ON [dbo].[c_EmpExc] ([DocDate])
  ON [PRIMARY]
GO

CREATE INDEX [DocID]
  ON [dbo].[c_EmpExc] ([DocID])
  ON [PRIMARY]
GO

CREATE INDEX [EmpID]
  ON [dbo].[c_EmpExc] ([EmpID])
  ON [PRIMARY]
GO

CREATE INDEX [KursCC]
  ON [dbo].[c_EmpExc] ([KursCC])
  ON [PRIMARY]
GO

CREATE INDEX [KursMC]
  ON [dbo].[c_EmpExc] ([KursMC])
  ON [PRIMARY]
GO

CREATE INDEX [NewEmpID]
  ON [dbo].[c_EmpExc] ([NewEmpID])
  ON [PRIMARY]
GO

CREATE INDEX [OurID]
  ON [dbo].[c_EmpExc] ([OurID])
  ON [PRIMARY]
GO

CREATE INDEX [StockID]
  ON [dbo].[c_EmpExc] ([StockID])
  ON [PRIMARY]
GO

CREATE INDEX [SumAC]
  ON [dbo].[c_EmpExc] ([SumAC])
  ON [PRIMARY]
GO
...
SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_c_EmpExc] ON [c_EmpExc]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_c_EmpExc', N'Last', N'UPDATE'
GO
