CREATE TABLE [dbo].[r_WrkTypes] (
  ...
  CONSTRAINT [pk_r_WrkTypes] PRIMARY KEY CLUSTERED ([WrkID])
)
ON [PRIMARY]
GO

CREATE UNIQUE INDEX [ChID]
  ON [dbo].[r_WrkTypes] ([ChID])
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [WrkName]
  ON [dbo].[r_WrkTypes] ([WrkName])
  ON [PRIMARY]
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_WrkTypes.ChID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_WrkTypes.WrkID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_WrkTypes.PriceCC'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_WrkTypes.Value1'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_WrkTypes.Value2'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_WrkTypes.Value3'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_WrkTypes] ON [r_WrkTypes]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_WrkTypes', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_WrkTypes] ON [r_WrkTypes]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_WrkTypes', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_WrkTypes] ON [r_WrkTypes]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_WrkTypes', N'Last', N'DELETE'
GO