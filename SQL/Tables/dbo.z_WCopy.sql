CREATE TABLE [dbo].[z_WCopy] (
  ...
  CONSTRAINT [_pk_z_WCopy] PRIMARY KEY CLUSTERED ([CopyID])
)
ON [PRIMARY]
TEXTIMAGE_ON [PRIMARY]
GO

CREATE UNIQUE INDEX [CopyName]
  ON [dbo].[z_WCopy] ([CopyName])
  ON [PRIMARY]
GO

CREATE INDEX [DstDocType]
  ON [dbo].[z_WCopy] ([DstDocType])
  ON [PRIMARY]
GO

CREATE INDEX [SrcDocType]
  ON [dbo].[z_WCopy] ([SrcDocType])
  ON [PRIMARY]
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.z_WCopy.CopyID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.z_WCopy.SrcDocType'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.z_WCopy.DstDocType'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.z_WCopy.IsSaved'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.z_WCopy.IsChange'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.z_WCopy.IsAutoChange'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.z_WCopy.DBSourceMode'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.z_WCopy.UseDisableControls'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.z_WCopy.UseMasterField'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.z_WCopy.MarkCopyInBKeep'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.z_WCopy.UpdateStatID'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_z_WCopy] ON [z_WCopy]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_z_WCopy', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_z_WCopy] ON [z_WCopy]
FOR UPDATE AS
