CREATE TABLE [dbo].[r_GAccFA] (
  ...
  CONSTRAINT [_pk_r_GAccFA] PRIMARY KEY CLUSTERED ([GAccID])
)
ON [PRIMARY]
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GAccFA.GAccID'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_GAccFA] ON [r_GAccFA]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_GAccFA', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_GAccFA] ON [r_GAccFA]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_GAccFA', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_GAccFA] ON [r_GAccFA]FOR DELETE AS/* r_GAccFA - План счетов - Формулы аналитики - DELETE TRIGGER */BEGIN  SET NOCOUNT ON/* Удаление регистрации создания записи */  DELETE z_LogCreate FROM z_LogCreate m, deleted i  WHERE m.TableCode = 10707004 AND m.PKValue =     '[' + cast(i.GAccID as varchar(200)) + ']'/* Удаление регистрации изменения записи */  DELETE z_LogUpdate FROM z_LogUpdate m, deleted i  WHERE m.TableCode = 10707004 AND m.PKValue =     '[' + cast(i.GAccID as varchar(200)) + ']'/* Регистрация удаления записи */  INSERT INTO z_LogDelete (TableCode, ChID, PKValue, UserCode)  SELECT 10707004, 0,     '[' + cast(d.GAccID as varchar(200)) + ']'          , dbo.zf_GetUserCode() FROM deleted dEND
GO

EXEC sp_settriggerorder N'dbo.TRel3_Del_r_GAccFA', N'Last', N'DELETE'
GO