CREATE TABLE [dbo].[r_BServs] (
  ...
  CONSTRAINT [pk_r_BServs] PRIMARY KEY CLUSTERED ([BServID])
)
ON [PRIMARY]
GO

CREATE UNIQUE INDEX [BServName]
  ON [dbo].[r_BServs] ([BServName])
  ON [PRIMARY]
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_BServs] ON [r_BServs]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_BServs', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_BServs] ON [r_BServs]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_BServs', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_BServs] ON [r_BServs]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_BServs', N'Last', N'DELETE'
GO