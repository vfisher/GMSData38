CREATE TABLE [dbo].[z_WCopyFV] (
  ...
  CONSTRAINT [_pk_z_WCopyFV] PRIMARY KEY CLUSTERED ([AChID], [FieldPosID], [VariantPosID])
)
ON [PRIMARY]
...
CREATE UNIQUE INDEX [NoDuplicate]
  ON [dbo].[z_WCopyFV] ([UVarType], [UIntPosID])
  ON [PRIMARY]
GO

CREATE INDEX [UIntPosID]
  ON [dbo].[z_WCopyFV] ([UIntPosID])
  ON [PRIMARY]
GO

CREATE INDEX [UVarPosID]
  ON [dbo].[z_WCopyFV] ([UVarPosID])
  ON [PRIMARY]
GO

CREATE INDEX [UVarType]
  ON [dbo].[z_WCopyFV] ([UVarType])
  ON [PRIMARY]
GO

CREATE INDEX [z_WCopyFz_WCopyFV]
  ON [dbo].[z_WCopyFV] ([AChID], [FieldPosID])
  ON [PRIMARY]
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.z_WCopyFV.AChID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.z_WCopyFV.FieldPosID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.z_WCopyFV.VariantPosID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.z_WCopyFV.UseDefault'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.z_WCopyFV.FieldAgrType'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.z_WCopyFV.AskFilter'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.z_WCopyFV.UVarPosID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.z_WCopyFV.UVarType'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.z_WCopyFV.UIntPosID'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_z_WCopyFV] ON [z_WCopyFV]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_z_WCopyFV', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_z_WCopyFV] ON [z_WCopyFV]
FOR UPDATE AS
