CREATE TABLE [dbo].[r_StockSubs] (
  ...
  CONSTRAINT [pk_r_StockSubs] PRIMARY KEY CLUSTERED ([StockID], [DepID])
)
ON [PRIMARY]
GO
...
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_StockSubs] ON [r_StockSubs]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_StockSubs', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_StockSubs] ON [r_StockSubs]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_StockSubs', N'Last', N'UPDATE'
GO