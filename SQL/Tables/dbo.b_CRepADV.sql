CREATE TABLE [dbo].[b_CRepADV] (
  ...
  CONSTRAINT [_pk_b_CRepADV] PRIMARY KEY CLUSTERED ([ChID], [DocDesc])
)
ON [PRIMARY]
GO

CREATE INDEX [ChID]
  ON [dbo].[b_CRepADV] ([ChID])
  ON [PRIMARY]
GO

CREATE INDEX [GOperID]
  ON [dbo].[b_CRepADV] ([GOperID])
  ON [PRIMARY]
GO

CREATE INDEX [GVTAccID]
  ON [dbo].[b_CRepADV] ([GVTAccID])
  ON [PRIMARY]
GO

CREATE INDEX [VCodeID1]
  ON [dbo].[b_CRepADV] ([VCodeID1])
  ON [PRIMARY]
GO

CREATE INDEX [VCodeID2]
  ON [dbo].[b_CRepADV] ([VCodeID2])
  ON [PRIMARY]
GO

CREATE INDEX [VCodeID3]
  ON [dbo].[b_CRepADV] ([VCodeID3])
  ON [PRIMARY]
GO

CREATE INDEX [VCodeID4]
  ON [dbo].[b_CRepADV] ([VCodeID4])
  ON [PRIMARY]
GO

CREATE INDEX [VCodeID5]
  ON [dbo].[b_CRepADV] ([VCodeID5])
  ON [PRIMARY]
GO

CREATE INDEX [ZTotals]
  ON [dbo].[b_CRepADV] ([ChID], [SumCC_nt], [TaxSum], [SumCC_wt])
  ON [PRIMARY]
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_CRepADV.ChID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_CRepADV.VCodeID1'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_CRepADV.VCodeID2'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_CRepADV.VCodeID3'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_CRepADV.VCodeID4'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_CRepADV.VCodeID5'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_CRepADV.SumCC_nt'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_CRepADV.TaxSum'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_CRepADV.SumCC_wt'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_CRepADV.GOperID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_CRepADV.GTranID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_CRepADV.GVTSum_wt'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_CRepADV.GVTTaxSum'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_CRepADV.GVTAccID'
GO
...
SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_b_CRepADV] ON [b_CRepADV]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_b_CRepADV', N'Last', N'UPDATE'
GO
