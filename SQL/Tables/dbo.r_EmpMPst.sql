CREATE TABLE [dbo].[r_EmpMPst] (
  ...
  CONSTRAINT [_pk_r_EmpMPst] PRIMARY KEY CLUSTERED ([OurID], [EmpID], [BDate])
)
ON [PRIMARY]
GO

CREATE INDEX [BDate]
  ON [dbo].[r_EmpMPst] ([BDate])
  ON [PRIMARY]
GO

CREATE INDEX [DepID]
  ON [dbo].[r_EmpMPst] ([DepID])
  ON [PRIMARY]
GO

CREATE INDEX [EDate]
  ON [dbo].[r_EmpMPst] ([EDate])
  ON [PRIMARY]
GO

CREATE INDEX [r_EmpMOr_EmpMPst]
  ON [dbo].[r_EmpMPst] ([OurID], [EmpID])
  ON [PRIMARY]
GO

CREATE INDEX [r_PostMCr_EmpMPst]
  ON [dbo].[r_EmpMPst] ([PostID], [EmpClass])
  ON [PRIMARY]
GO

CREATE INDEX [ShedID]
  ON [dbo].[r_EmpMPst] ([ShedID])
  ON [PRIMARY]
GO

CREATE INDEX [SubID]
  ON [dbo].[r_EmpMPst] ([SubID])
  ON [PRIMARY]
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_EmpMPst.OurID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_EmpMPst.EmpID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_EmpMPst.SubID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_EmpMPst.DepID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_EmpMPst.PostID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_EmpMPst.EmpClass'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_EmpMPst.WorkCond'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_EmpMPst.ShedID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_EmpMPst.SalaryType'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_EmpMPst.SalaryForm'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_EmpMPst.SalaryMethod'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_EmpMPst.BSalary'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_EmpMPst.BSalaryPrc'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_EmpMPst.AdvSum'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_EmpMPst.SalaryQty'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_EmpMPst.Joint'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_EmpMPst.IsDisDoc'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_EmpMPst.IsGivDoc'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_EmpMPst.TimeNormType'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_EmpMPst] ON [r_EmpMPst]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_EmpMPst', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_EmpMPst] ON [r_EmpMPst]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_EmpMPst', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_EmpMPst] ON [r_EmpMPst]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_EmpMPst', N'Last', N'DELETE'
GO