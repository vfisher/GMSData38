CREATE TABLE [dbo].[r_Taxes] (
  ...
  CONSTRAINT [pk_r_Taxes] PRIMARY KEY CLUSTERED ([TaxTypeID])
)
ON [PRIMARY]
GO

CREATE UNIQUE INDEX [TaxName]
  ON [dbo].[r_Taxes] ([TaxName])
  ON [PRIMARY]
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_Taxes] ON [r_Taxes]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_Taxes', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_Taxes] ON [r_Taxes]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_Taxes', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_Taxes] ON [r_Taxes]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_Taxes', N'Last', N'DELETE'
GO