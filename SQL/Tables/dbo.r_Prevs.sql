CREATE TABLE [dbo].[r_Prevs] (
  ...
  CONSTRAINT [pk_r_Prevs] PRIMARY KEY CLUSTERED ([PrevID])
)
ON [PRIMARY]
GO
...
CREATE INDEX [PrevFiscID]
  ON [dbo].[r_Prevs] ([PrevFiscID])
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [PrevName]
  ON [dbo].[r_Prevs] ([PrevName])
  ON [PRIMARY]
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_Prevs.ChID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_Prevs.PrevID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_Prevs.NoTaxMin'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_Prevs.UseTotPensFundPrc'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_Prevs.UseTotUnEmployPrc'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_Prevs.UseTotSocInsurePrc'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_Prevs.UseTotAccidentPrc'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_Prevs.UseIncomeTaxPrc'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_Prevs.UsePensFundPrc'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_Prevs.UseUnEmployPrc'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_Prevs.UseSocInsurePrc'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_Prevs] ON [r_Prevs]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_Prevs', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_Prevs] ON [r_Prevs]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_Prevs', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_Prevs] ON [r_Prevs]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_Prevs', N'Last', N'DELETE'
GO