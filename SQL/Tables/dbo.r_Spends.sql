CREATE TABLE [dbo].[r_Spends] (
  ...
  CONSTRAINT [pk_r_Spends] PRIMARY KEY CLUSTERED ([SpendCode])
)
ON [PRIMARY]
GO

CREATE UNIQUE INDEX [ChID]
  ON [dbo].[r_Spends] ([ChID])
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [SpendName]
  ON [dbo].[r_Spends] ([SpendName])
  ON [PRIMARY]
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_Spends] ON [r_Spends]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_Spends', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_Spends] ON [r_Spends]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_Spends', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_Spends] ON [r_Spends]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_Spends', N'Last', N'DELETE'
GO