CREATE TABLE [dbo].[r_GOperD] (
  ...
  CONSTRAINT [_pk_r_GOperD] PRIMARY KEY CLUSTERED ([GOperID], [SrcPosID])
)
ON [PRIMARY]
GO

CREATE INDEX [C_AssID]
  ON [dbo].[r_GOperD] ([C_AssID])
  ON [PRIMARY]
GO

CREATE INDEX [C_CodeID1]
  ON [dbo].[r_GOperD] ([C_CodeID1])
  ON [PRIMARY]
GO

CREATE INDEX [C_CodeID2]
  ON [dbo].[r_GOperD] ([C_CodeID2])
  ON [PRIMARY]
GO

CREATE INDEX [C_CodeID3]
  ON [dbo].[r_GOperD] ([C_CodeID3])
  ON [PRIMARY]
GO

CREATE INDEX [C_CodeID4]
  ON [dbo].[r_GOperD] ([C_CodeID4])
  ON [PRIMARY]
GO

CREATE INDEX [C_CodeID5]
  ON [dbo].[r_GOperD] ([C_CodeID5])
  ON [PRIMARY]
GO

CREATE INDEX [C_CompID]
  ON [dbo].[r_GOperD] ([C_CompID])
  ON [PRIMARY]
GO

CREATE INDEX [C_EmpID]
  ON [dbo].[r_GOperD] ([C_EmpID])
  ON [PRIMARY]
GO

CREATE INDEX [C_GAccEExp]
  ON [dbo].[r_GOperD] ([C_GAccEExp])
  ON [PRIMARY]
GO

CREATE INDEX [C_GAccRExp]
  ON [dbo].[r_GOperD] ([C_GAccRExp])
  ON [PRIMARY]
GO

CREATE INDEX [C_ProdID]
  ON [dbo].[r_GOperD] ([C_ProdID])
  ON [PRIMARY]
GO

CREATE INDEX [C_StockID]
  ON [dbo].[r_GOperD] ([C_StockID])
  ON [PRIMARY]
GO

CREATE INDEX [C_VolID]
  ON [dbo].[r_GOperD] ([C_VolID])
  ON [PRIMARY]
GO

CREATE INDEX [D_AssID]
  ON [dbo].[r_GOperD] ([D_AssID])
  ON [PRIMARY]
GO

CREATE INDEX [D_CodeID1]
  ON [dbo].[r_GOperD] ([D_CodeID1])
  ON [PRIMARY]
GO

CREATE INDEX [D_CodeID2]
  ON [dbo].[r_GOperD] ([D_CodeID2])
  ON [PRIMARY]
GO

CREATE INDEX [D_CodeID3]
  ON [dbo].[r_GOperD] ([D_CodeID3])
  ON [PRIMARY]
GO

CREATE INDEX [D_CodeID4]
  ON [dbo].[r_GOperD] ([D_CodeID4])
  ON [PRIMARY]
GO

CREATE INDEX [D_CodeID5]
  ON [dbo].[r_GOperD] ([D_CodeID5])
  ON [PRIMARY]
GO

CREATE INDEX [D_CompID]
  ON [dbo].[r_GOperD] ([D_CompID])
  ON [PRIMARY]
GO

CREATE INDEX [D_EmpID]
  ON [dbo].[r_GOperD] ([D_EmpID])
  ON [PRIMARY]
GO

CREATE INDEX [D_GAccEExp]
  ON [dbo].[r_GOperD] ([D_GAccEExp])
  ON [PRIMARY]
GO

CREATE INDEX [D_GAccRExp]
  ON [dbo].[r_GOperD] ([D_GAccRExp])
  ON [PRIMARY]
GO

CREATE INDEX [D_ProdID]
  ON [dbo].[r_GOperD] ([D_ProdID])
  ON [PRIMARY]
GO

CREATE INDEX [D_StockID]
  ON [dbo].[r_GOperD] ([D_StockID])
  ON [PRIMARY]
GO

CREATE INDEX [D_VolID]
  ON [dbo].[r_GOperD] ([D_VolID])
  ON [PRIMARY]
GO

CREATE INDEX [GOperID]
  ON [dbo].[r_GOperD] ([GOperID])
  ON [PRIMARY]
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.GOperID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.SrcPosID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.InCC'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.D_IncQty'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.D_AddQty'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.C_IncQty'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.C_AddQty'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.D_CompID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.D_EmpID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.D_CodeID1'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.D_CodeID2'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.D_CodeID3'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.D_CodeID4'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.D_CodeID5'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.D_StockID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.D_ProdID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.D_AssID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.D_VolID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.C_CompID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.C_EmpID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.C_CodeID1'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.C_CodeID2'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.C_CodeID3'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.C_CodeID4'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.C_CodeID5'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.C_StockID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.C_ProdID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.C_AssID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.C_VolID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.D_CompVol'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.D_EmpVol'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.D_CodeVol1'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.D_CodeVol2'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.D_CodeVol3'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.D_CodeVol4'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.D_CodeVol5'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.D_StockVol'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.D_ProdVol'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.D_AssVol'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.D_VolVol'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.C_CompVol'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.C_EmpVol'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.C_CodeVol1'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.C_CodeVol2'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.C_CodeVol3'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.C_CodeVol4'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.C_CodeVol5'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.C_StockVol'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.C_ProdVol'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.C_AssVol'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.C_VolVol'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperD.ConductQty'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_GOperD] ON [r_GOperD]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_GOperD', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_GOperD] ON [r_GOperD]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_GOperD', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_GOperD] ON [r_GOperD]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_GOperD', N'Last', N'DELETE'
GO