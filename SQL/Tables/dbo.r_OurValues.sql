CREATE TABLE [dbo].[r_OurValues] (
  ...
  CONSTRAINT [pk_r_OurValues] PRIMARY KEY CLUSTERED ([OurID], [VarName])
)
ON [PRIMARY]
GO
...
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_OurValues] ON [r_OurValues]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_OurValues', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_OurValues] ON [r_OurValues]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_OurValues', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_OurValues] ON [r_OurValues]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_OurValues', N'Last', N'DELETE'
GO