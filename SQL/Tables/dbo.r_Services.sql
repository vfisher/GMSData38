CREATE TABLE [dbo].[r_Services] (
  ...
  CONSTRAINT [pk_r_Services] PRIMARY KEY CLUSTERED ([SrvcID])
)
ON [PRIMARY]
GO

CREATE UNIQUE INDEX [ChID]
  ON [dbo].[r_Services] ([ChID])
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [ProdID_StockID]
  ON [dbo].[r_Services] ([ProdID], [StockID])
  ON [PRIMARY]
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_Services] ON [r_Services]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_Services', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_Services] ON [r_Services]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_Services', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_Services] ON [r_Services]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_Services', N'Last', N'DELETE'
GO