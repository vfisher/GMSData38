CREATE TABLE [dbo].[p_CommunalTaxD] (
  ...
  CONSTRAINT [pk_p_CommunalTaxD] PRIMARY KEY CLUSTERED ([ChID], [TaxRegionID])
)
ON [PRIMARY]
GO

CREATE UNIQUE INDEX [AChID]
  ON [dbo].[p_CommunalTaxD] ([AChID])
  ON [PRIMARY]
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_p_CommunalTaxD] ON [p_CommunalTaxD]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_p_CommunalTaxD', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_p_CommunalTaxD] ON [p_CommunalTaxD]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_p_CommunalTaxD', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_p_CommunalTaxD] ON [p_CommunalTaxD]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_p_CommunalTaxD', N'Last', N'DELETE'
GO