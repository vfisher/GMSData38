CREATE TABLE [dbo].[r_Uni] (
  ...
  CONSTRAINT [pk_r_Uni] PRIMARY KEY CLUSTERED ([RefTypeID], [RefID])
)
ON [PRIMARY]
GO

CREATE UNIQUE INDEX [UniqueName]
  ON [dbo].[r_Uni] ([RefTypeID], [RefName])
  ON [PRIMARY]
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_Uni] ON [r_Uni]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_Uni', N'Last', N'DELETE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_Uni] ON [r_Uni]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_Uni', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_Uni] ON [r_Uni]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_Uni', N'Last', N'INSERT'
GO
