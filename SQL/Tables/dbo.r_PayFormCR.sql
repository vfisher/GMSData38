CREATE TABLE [dbo].[r_PayFormCR] (
  ...
  CONSTRAINT [pk_r_PayFormCR] PRIMARY KEY CLUSTERED ([PayFormCode], [CashType], [CRPayFormCode])
)
ON [PRIMARY]
GO
...
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_PayFormCR] ON [r_PayFormCR]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_PayFormCR', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_PayFormCR] ON [r_PayFormCR]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_PayFormCR', N'Last', N'UPDATE'
GO