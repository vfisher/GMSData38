CREATE TABLE [dbo].[t_CRRetDLV] (
  ...
  CONSTRAINT [pk_t_CRRetDLV] PRIMARY KEY CLUSTERED ([ChID], [SrcPosID], [LevyID])
)
ON [PRIMARY]
GO
...
GO
CREATE TRIGGER [dbo].[TAU1_INS_t_CRRetDLV] ON [t_CRRetDLV]
FOR INSERT
AS
BEGIN
...
SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TAU2_UPD_t_CRRetDLV] ON [t_CRRetDLV]
FOR UPDATE
AS
BEGIN
  IF @@RowCount = 0 RETURN
...
SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TAU3_DEL_t_CRRetDLV] ON [t_CRRetDLV]
FOR DELETE
AS
BEGIN
  IF @@RowCount = 0 RETURN
...
SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_t_CRRetDLV] ON [t_CRRetDLV]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_t_CRRetDLV', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_t_CRRetDLV] ON [t_CRRetDLV]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_t_CRRetDLV', N'Last', N'UPDATE'
GO