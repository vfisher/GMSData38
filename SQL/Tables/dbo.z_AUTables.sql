CREATE TABLE [dbo].[z_AUTables] (
  ...
  CONSTRAINT [PK_z_AUTables] PRIMARY KEY CLUSTERED ([AUID], [CTableCode])
)
ON [PRIMARY]
GO

CREATE INDEX [AUID]
  ON [dbo].[z_AUTables] ([AUID])
  ON [PRIMARY]
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_z_AUTables] ON [z_AUTables]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_z_AUTables', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_z_AUTables] ON [z_AUTables]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_z_AUTables', N'Last', N'UPDATE'
GO

ALTER TABLE [dbo].[z_AUTables]
  ADD CONSTRAINT [FK_z_AUTables_z_AutoUpdate] FOREIGN KEY ([AUID]) REFERENCES [dbo].[z_AutoUpdate] ([AUID]) ON DELETE CASCADE ON UPDATE CASCADE
GO