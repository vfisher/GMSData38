CREATE TABLE [dbo].[b_GViewU] (
  ...
  CONSTRAINT [_pk_b_GViewU] PRIMARY KEY CLUSTERED ([ViewID], [UserID])
)
ON [PRIMARY]
GO

CREATE INDEX [UserID]
  ON [dbo].[b_GViewU] ([UserID])
  ON [PRIMARY]
GO

CREATE INDEX [ViewID]
  ON [dbo].[b_GViewU] ([ViewID])
  ON [PRIMARY]
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_GViewU.ViewID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_GViewU.UserID'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_b_GViewU] ON [b_GViewU]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_b_GViewU', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_b_GViewU] ON [b_GViewU]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_b_GViewU', N'Last', N'UPDATE'
GO