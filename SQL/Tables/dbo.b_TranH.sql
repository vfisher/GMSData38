CREATE TABLE [dbo].[b_TranH] (
  ...
  CONSTRAINT [pk_b_TranH] PRIMARY KEY CLUSTERED ([ChID])
)
ON [PRIMARY]
GO

CREATE INDEX [C_AssID]
  ON [dbo].[b_TranH] ([C_AssID])
  ON [PRIMARY]
GO

CREATE INDEX [C_CodeID1]
  ON [dbo].[b_TranH] ([C_CodeID1])
  ON [PRIMARY]
GO

CREATE INDEX [C_CodeID2]
  ON [dbo].[b_TranH] ([C_CodeID2])
  ON [PRIMARY]
GO

CREATE INDEX [C_CodeID3]
  ON [dbo].[b_TranH] ([C_CodeID3])
  ON [PRIMARY]
GO

CREATE INDEX [C_CodeID4]
  ON [dbo].[b_TranH] ([C_CodeID4])
  ON [PRIMARY]
GO

CREATE INDEX [C_CodeID5]
  ON [dbo].[b_TranH] ([C_CodeID5])
  ON [PRIMARY]
GO

CREATE INDEX [C_CompID]
  ON [dbo].[b_TranH] ([C_CompID])
  ON [PRIMARY]
GO

CREATE INDEX [C_EmpID]
  ON [dbo].[b_TranH] ([C_EmpID])
  ON [PRIMARY]
GO

CREATE INDEX [C_GAccID]
  ON [dbo].[b_TranH] ([C_GAccID])
  ON [PRIMARY]
GO

CREATE INDEX [C_GVolID]
  ON [dbo].[b_TranH] ([C_GVolID])
  ON [PRIMARY]
GO

CREATE INDEX [C_ProdID]
  ON [dbo].[b_TranH] ([C_ProdID])
  ON [PRIMARY]
GO

CREATE INDEX [C_StockID]
  ON [dbo].[b_TranH] ([C_StockID])
  ON [PRIMARY]
GO

CREATE INDEX [CurrID]
  ON [dbo].[b_TranH] ([CurrID])
  ON [PRIMARY]
GO

CREATE INDEX [D_AssID]
  ON [dbo].[b_TranH] ([D_AssID])
  ON [PRIMARY]
GO

CREATE INDEX [D_CodeID1]
  ON [dbo].[b_TranH] ([D_CodeID1])
  ON [PRIMARY]
GO

CREATE INDEX [D_CodeID2]
  ON [dbo].[b_TranH] ([D_CodeID2])
  ON [PRIMARY]
GO

CREATE INDEX [D_CodeID3]
  ON [dbo].[b_TranH] ([D_CodeID3])
  ON [PRIMARY]
GO

CREATE INDEX [D_CodeID4]
  ON [dbo].[b_TranH] ([D_CodeID4])
  ON [PRIMARY]
GO

CREATE INDEX [D_CodeID5]
  ON [dbo].[b_TranH] ([D_CodeID5])
  ON [PRIMARY]
GO

CREATE INDEX [D_CompID]
  ON [dbo].[b_TranH] ([D_CompID])
  ON [PRIMARY]
GO

CREATE INDEX [D_EmpID]
  ON [dbo].[b_TranH] ([D_EmpID])
  ON [PRIMARY]
GO

CREATE INDEX [D_GAccID]
  ON [dbo].[b_TranH] ([D_GAccID])
  ON [PRIMARY]
GO

CREATE INDEX [D_GVolID]
  ON [dbo].[b_TranH] ([D_GVolID])
  ON [PRIMARY]
GO

CREATE INDEX [D_ProdID]
  ON [dbo].[b_TranH] ([D_ProdID])
  ON [PRIMARY]
GO

CREATE INDEX [D_StockID]
  ON [dbo].[b_TranH] ([D_StockID])
  ON [PRIMARY]
GO

CREATE INDEX [OurID]
  ON [dbo].[b_TranH] ([OurID])
  ON [PRIMARY]
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_TranH.ChID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_TranH.OurID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_TranH.CurrID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_TranH.KursMC'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_TranH.KursCC'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_TranH.SumAC'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_TranH.GTranID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_TranH.D_GAccID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_TranH.C_GAccID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_TranH.D_CompID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_TranH.C_CompID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_TranH.D_EmpID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_TranH.C_EmpID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_TranH.D_CodeID1'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_TranH.C_CodeID1'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_TranH.D_CodeID2'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_TranH.C_CodeID2'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_TranH.D_CodeID3'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_TranH.C_CodeID3'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_TranH.D_CodeID4'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_TranH.C_CodeID4'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_TranH.D_CodeID5'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_TranH.C_CodeID5'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_TranH.D_StockID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_TranH.C_StockID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_TranH.D_ProdID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_TranH.C_ProdID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_TranH.D_AssID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_TranH.C_AssID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_TranH.D_GVolID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_TranH.C_GVolID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_TranH.D_Qty'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_TranH.C_Qty'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_b_TranH] ON [b_TranH]
FOR DELETE AS
...
/* Проверка открытого периода */
  ...
  IF (@ADate IS NOT NULL) 
    BEGIN
      SELECT @Err = FORMATMESSAGE('%s (%s):' + CHAR(13) + dbo.zf_Translate('Дата или одна из дат изменяемого документа меньше даты открытого периода %s для фирмы с кодом %s') ,dbo.zf_Translate('Ручные проводки'), 'b_TranH', dbo.zf_DatetoStr(@ADate), CAST(@OurID as varchar(10)))
      RAISERROR (@Err, 18, 1)
      ROLLBACK TRAN
      RETURN
    END
  ...
  IF (@ADate IS NOT NULL) 
    BEGIN
      SELECT @Err = FORMATMESSAGE('%s (%s):' + CHAR(13) + dbo.zf_Translate('Дата или одна из дат изменяемого документа больше даты открытого периода %s для фирмы с кодом %s') ,dbo.zf_Translate('Ручные проводки'), 'b_TranH', dbo.zf_DatetoStr(@ADate), CAST(@OurID as varchar(10)))
      RAISERROR (@Err, 18, 1)
      ROLLBACK TRAN
      RETURN
    END
...
/* Возможно ли редактирование документа */
    IF EXISTS(SELECT * FROM deleted a WHERE dbo.zf_CanChangeDoc(14335, a.ChID, a.StateCode) = 0)
      BEGIN
        ...
        SELECT @Err2 = FORMATMESSAGE(dbo.zf_Translate('Изменение документа ''%s'' в данном статусе запрещено.'), dbo.zf_Translate('Ручные проводки'))
        RAISERROR(@Err2, 18, 1)
        ROLLBACK TRAN
        RETURN
      END
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_b_TranH', N'Last', N'DELETE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_b_TranH] ON [b_TranH]
FOR UPDATE AS
...
/* Проверка открытого периода */
  ...
  IF (@ADate IS NOT NULL) 
    BEGIN
      SELECT @Err = FORMATMESSAGE('%s (%s):' + CHAR(13) + dbo.zf_Translate('Новая дата или одна из дат документа меньше даты открытого периода %s для фирмы с кодом %s') ,dbo.zf_Translate('Ручные проводки'), 'b_TranH', dbo.zf_DatetoStr(@ADate), CAST(@OurID as varchar(10)))
      RAISERROR (@Err, 18, 1)
      ROLLBACK TRAN
      RETURN
    END
  ...
  IF (@ADate IS NOT NULL) 
    BEGIN
      SELECT @Err = FORMATMESSAGE('%s (%s):' + CHAR(13) + dbo.zf_Translate('Новая дата или одна из дат документа больше даты открытого периода %s для фирмы с кодом %s') ,dbo.zf_Translate('Ручные проводки'), 'b_TranH', dbo.zf_DatetoStr(@ADate), CAST(@OurID as varchar(10)))
      RAISERROR (@Err, 18, 1)
      ROLLBACK TRAN
      RETURN
    END
...
/* Обработка статуса */
  IF UPDATE(StateCode) AND EXISTS(SELECT * FROM inserted i, deleted d WHERE i.ChID = d.ChID AND dbo.zf_CanChangeState(14335, i.ChID, d.StateCode, i.StateCode) = 0)
    BEGIN
      ...
      SELECT @Err1 = FORMATMESSAGE(dbo.zf_Translate('Переход в указанный статус невозможен (%s).'), dbo.zf_Translate('Ручные проводки'))
      RAISERROR(@Err1, 18, 1)
      ROLLBACK TRAN
      RETURN
    END
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_b_TranH', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_b_TranH] ON [b_TranH]
FOR INSERT AS
...
/* Обработка статуса */
  IF EXISTS(SELECT * FROM inserted i WHERE dbo.zf_IsValidDocState(14335, i.StateCode) = 0)
    BEGIN
      DECLARE @Err1 varchar(200)
      SELECT @Err1 = FORMATMESSAGE(dbo.zf_Translate('Документ ''%s'' не может иметь указанный статус.'), dbo.zf_Translate('Ручные проводки'))
      RAISERROR(@Err1, 18, 1)
      ROLLBACK TRAN
      RETURN
    END
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_b_TranH', N'Last', N'INSERT'
GO
