CREATE TABLE [dbo].[r_Banks] (
  ...
  CONSTRAINT [pk_r_Banks] PRIMARY KEY CLUSTERED ([BankID])
)
ON [PRIMARY]
GO

CREATE UNIQUE INDEX [BankName]
  ON [dbo].[r_Banks] ([BankName])
  ON [PRIMARY]
GO
...
EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_Banks.ChID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_Banks.BankID'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_Banks] ON [r_Banks]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_Banks', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_Banks] ON [r_Banks]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_Banks', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_Banks] ON [r_Banks]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_Banks', N'Last', N'DELETE'
GO