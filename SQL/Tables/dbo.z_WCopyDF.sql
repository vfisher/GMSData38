CREATE TABLE [dbo].[z_WCopyDF] (
  ...
  CONSTRAINT [_pk_z_WCopyDF] PRIMARY KEY CLUSTERED ([AChID], [FieldPosID])
)
ON [PRIMARY]
GO

CREATE INDEX [AChID]
  ON [dbo].[z_WCopyDF] ([AChID])
  ON [PRIMARY]
GO

CREATE INDEX [FieldPosID]
  ON [dbo].[z_WCopyDF] ([FieldPosID])
  ON [PRIMARY]
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.z_WCopyDF.AChID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.z_WCopyDF.FieldPosID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.z_WCopyDF.UserField'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.z_WCopyDF.ForFilterMode'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_z_WCopyDF] ON [z_WCopyDF]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_z_WCopyDF', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_z_WCopyDF] ON [z_WCopyDF]
FOR UPDATE AS
