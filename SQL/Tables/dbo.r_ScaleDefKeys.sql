CREATE TABLE [dbo].[r_ScaleDefKeys] (
  ...
  CONSTRAINT [pk_r_ScaleDefKeys] PRIMARY KEY CLUSTERED ([ScaleDefID], [ScaleKey])
)
ON [PRIMARY]
GO

CREATE INDEX [ScaleKey]
  ON [dbo].[r_ScaleDefKeys] ([ScaleKey])
  ON [PRIMARY]
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_ScaleDefKeys] ON [r_ScaleDefKeys]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_ScaleDefKeys', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_ScaleDefKeys] ON [r_ScaleDefKeys]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_ScaleDefKeys', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_ScaleDefKeys] ON [r_ScaleDefKeys]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_ScaleDefKeys', N'Last', N'DELETE'
GO