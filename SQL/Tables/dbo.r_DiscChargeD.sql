CREATE TABLE [dbo].[r_DiscChargeD] (
  ...
  CONSTRAINT [pk_r_DiscChargeD] PRIMARY KEY CLUSTERED ([DiscCode], [SrcPosID])
)
ON [PRIMARY]
...
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_DiscChargeD] ON [r_DiscChargeD]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_DiscChargeD', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_DiscChargeD] ON [r_DiscChargeD]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_DiscChargeD', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_DiscChargeD] ON [r_DiscChargeD]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_DiscChargeD', N'Last', N'DELETE'
GO

ALTER TABLE [dbo].[r_DiscChargeD]
  ADD CONSTRAINT [FK_r_DiscChargeD_r_Discs] FOREIGN KEY ([DiscCode]) REFERENCES [dbo].[r_Discs] ([DiscCode]) ON DELETE CASCADE ON UPDATE CASCADE
GO