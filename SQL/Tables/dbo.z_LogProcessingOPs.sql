CREATE TABLE [dbo].[z_LogProcessingOPs] (
  ...
  CONSTRAINT [pk_z_LogProcessingOPs] PRIMARY KEY CLUSTERED ([ChID])
)
ON [PRIMARY]
GO

CREATE INDEX [DocTime_CRID]
  ON [dbo].[z_LogProcessingOPs] ([DocTime], [CRID])
  ON [PRIMARY]
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_z_LogProcessingOPs] ON [z_LogProcessingOPs]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_z_LogProcessingOPs', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_z_LogProcessingOPs] ON [z_LogProcessingOPs]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_z_LogProcessingOPs', N'Last', N'DELETE'
GO