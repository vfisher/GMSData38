CREATE TABLE [dbo].[r_CarrsC] (
  ...
  CONSTRAINT [pk_r_CarrsC] PRIMARY KEY CLUSTERED ([CarrCID])
)
ON [PRIMARY]
GO

CREATE UNIQUE INDEX [CarrCName]
  ON [dbo].[r_CarrsC] ([CarrCName])
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [ChID]
  ON [dbo].[r_CarrsC] ([ChID])
  ON [PRIMARY]
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_CarrsC.ChID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_CarrsC.CarrCID'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_CarrsC] ON [r_CarrsC]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_CarrsC', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_CarrsC] ON [r_CarrsC]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_CarrsC', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_CarrsC] ON [r_CarrsC]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_CarrsC', N'Last', N'DELETE'
GO