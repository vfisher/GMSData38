CREATE TABLE [dbo].[p_EmpInLExp] (
  ...
  CONSTRAINT [pk_p_EmpInLExp] PRIMARY KEY CLUSTERED ([ChID], [AccDate])
)
ON [PRIMARY]
GO
...
GO
CREATE TRIGGER [dbo].[TRel1_Ins_p_EmpInLExp] ON [p_EmpInLExp]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_p_EmpInLExp', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_p_EmpInLExp] ON [p_EmpInLExp]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_p_EmpInLExp', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_p_EmpInLExp] ON [p_EmpInLExp]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_p_EmpInLExp', N'Last', N'DELETE'
GO