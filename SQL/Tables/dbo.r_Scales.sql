CREATE TABLE [dbo].[r_Scales] (
  ...
  CONSTRAINT [pk_r_Scales] PRIMARY KEY CLUSTERED ([ScaleID])
)
ON [PRIMARY]
GO

CREATE UNIQUE INDEX [ChID]
  ON [dbo].[r_Scales] ([ChID])
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [ScaleName]
  ON [dbo].[r_Scales] ([ScaleName])
  ON [PRIMARY]
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_Scales] ON [r_Scales]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_Scales', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_Scales] ON [r_Scales]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_Scales', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_Scales] ON [r_Scales]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_Scales', N'Last', N'DELETE'
GO