CREATE TABLE [dbo].[r_EmpAdd] (
  ...
  CONSTRAINT [_pk_r_EmpAdd] PRIMARY KEY CLUSTERED ([EmpID], [BDate], [EDate])
)
ON [PRIMARY]
GO

CREATE INDEX [BDate]
  ON [dbo].[r_EmpAdd] ([BDate])
  ON [PRIMARY]
GO

CREATE INDEX [EDate]
  ON [dbo].[r_EmpAdd] ([EDate])
  ON [PRIMARY]
GO

CREATE INDEX [EmpID]
  ON [dbo].[r_EmpAdd] ([EmpID])
  ON [PRIMARY]
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_EmpAdd.EmpID'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_EmpAdd] ON [r_EmpAdd]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_EmpAdd', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_EmpAdd] ON [r_EmpAdd]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_EmpAdd', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_EmpAdd] ON [r_EmpAdd]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_EmpAdd', N'Last', N'DELETE'
GO