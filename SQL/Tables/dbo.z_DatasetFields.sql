CREATE TABLE [dbo].[z_DatasetFields] (
  ...
  CONSTRAINT [pk_z_DatasetFields] PRIMARY KEY CLUSTERED ([DSCode], [FieldName])
)
ON [PRIMARY]
GO

CREATE INDEX [FieldPosID]
  ON [dbo].[z_DatasetFields] ([FieldPosID])
  ON [PRIMARY]
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_z_DatasetFields] ON [z_DatasetFields]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_z_DatasetFields', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_z_DatasetFields] ON [z_DatasetFields]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_z_DatasetFields', N'Last', N'UPDATE'
GO

ALTER TABLE [dbo].[z_DatasetFields]
  ADD CONSTRAINT [FK_z_DatasetFields_z_FieldsRep] FOREIGN KEY ([FieldName]) REFERENCES [dbo].[z_FieldsRep] ([FieldName]) ON UPDATE CASCADE
GO