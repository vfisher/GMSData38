CREATE TABLE [dbo].[p_CWTimeCor] (
  ...
  CONSTRAINT [pk_p_CWTimeCor] PRIMARY KEY CLUSTERED ([OurID], [EmpID], [AppDate])
)
ON [PRIMARY]
GO
...
GO
CREATE TRIGGER [dbo].[TRel1_Ins_p_CWTimeCor] ON [p_CWTimeCor]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_p_CWTimeCor', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_p_CWTimeCor] ON [p_CWTimeCor]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_p_CWTimeCor', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_p_CWTimeCor] ON [p_CWTimeCor]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_p_CWTimeCor', N'Last', N'DELETE'
GO