CREATE TABLE [dbo].[r_Levies] (
  ...
  CONSTRAINT [pk_r_Levies] PRIMARY KEY CLUSTERED ([LevyID])
)
ON [PRIMARY]
GO
...
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_Levies] ON [r_Levies]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_Levies', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_Levies] ON [r_Levies]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_Levies', N'Last', N'DELETE'
GO