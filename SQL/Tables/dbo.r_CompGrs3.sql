CREATE TABLE [dbo].[r_CompGrs3] (
  ...
  CONSTRAINT [pk_r_CompGrs3] PRIMARY KEY CLUSTERED ([CompGrID3])
)
ON [PRIMARY]
GO

CREATE UNIQUE INDEX [ChID]
  ON [dbo].[r_CompGrs3] ([ChID])
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [CompGrName3]
  ON [dbo].[r_CompGrs3] ([CompGrName3])
  ON [PRIMARY]
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_CompGrs3] ON [r_CompGrs3]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_CompGrs3', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_CompGrs3] ON [r_CompGrs3]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_CompGrs3', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_CompGrs3] ON [r_CompGrs3]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_CompGrs3', N'Last', N'DELETE'
GO