CREATE TABLE [dbo].[r_CandidateFiles] (
  ...
  CONSTRAINT [pk_r_CandidateFiles] PRIMARY KEY CLUSTERED ([CandidateID], [SrcPosID])
)
ON [PRIMARY]
GO

CREATE INDEX [CandidateID]
  ON [dbo].[r_CandidateFiles] ([CandidateID])
  ON [PRIMARY]
GO

CREATE INDEX [EmpDocID]
  ON [dbo].[r_CandidateFiles] ([EmpDocID])
  ON [PRIMARY]
GO

CREATE INDEX [FileDate]
  ON [dbo].[r_CandidateFiles] ([FileDate])
  ON [PRIMARY]
GO

CREATE INDEX [FileID]
  ON [dbo].[r_CandidateFiles] ([FileID])
  ON [PRIMARY]
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_CandidateFiles] ON [r_CandidateFiles]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_CandidateFiles', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_CandidateFiles] ON [r_CandidateFiles]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_CandidateFiles', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_CandidateFiles] ON [r_CandidateFiles]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_CandidateFiles', N'Last', N'DELETE'
GO