CREATE TABLE [dbo].[r_DiscSaleD] (
  ...
  CONSTRAINT [pk_r_DiscSaleD] PRIMARY KEY CLUSTERED ([DiscCode], [SrcPosID])
)
ON [PRIMARY]
...
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_DiscSaleD] ON [r_DiscSaleD]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_DiscSaleD', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_DiscSaleD] ON [r_DiscSaleD]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_DiscSaleD', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_DiscSaleD] ON [r_DiscSaleD]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_DiscSaleD', N'Last', N'DELETE'
GO

ALTER TABLE [dbo].[r_DiscSaleD]
  ADD CONSTRAINT [FK_r_DiscSaleD_r_Discs] FOREIGN KEY ([DiscCode]) REFERENCES [dbo].[r_Discs] ([DiscCode]) ON DELETE CASCADE ON UPDATE CASCADE
GO