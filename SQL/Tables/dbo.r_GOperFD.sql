CREATE TABLE [dbo].[r_GOperFD] (
  ...
  CONSTRAINT [_pk_r_GOperFD] PRIMARY KEY CLUSTERED ([GOperID], [SrcPosID])
)
ON [PRIMARY]
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperFD.GOperID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_GOperFD.SrcPosID'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_GOperFD] ON [r_GOperFD]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_GOperFD', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_GOperFD] ON [r_GOperFD]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_GOperFD', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_GOperFD] ON [r_GOperFD]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_GOperFD', N'Last', N'DELETE'
GO