CREATE TABLE [dbo].[r_AssetC] (
  ...
  CONSTRAINT [pk_r_AssetC] PRIMARY KEY CLUSTERED ([ACatID])
)
ON [PRIMARY]
GO

CREATE UNIQUE INDEX [ACatName]
  ON [dbo].[r_AssetC] ([ACatName])
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [ChID]
  ON [dbo].[r_AssetC] ([ChID])
  ON [PRIMARY]
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_AssetC.ChID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_AssetC.ACatID'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_AssetC] ON [r_AssetC]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_AssetC', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_AssetC] ON [r_AssetC]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_AssetC', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_AssetC] ON [r_AssetC]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_AssetC', N'Last', N'DELETE'
GO