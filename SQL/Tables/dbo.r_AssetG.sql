CREATE TABLE [dbo].[r_AssetG] (
  ...
  CONSTRAINT [pk_r_AssetG] PRIMARY KEY CLUSTERED ([AGrID])
)
ON [PRIMARY]
GO

CREATE UNIQUE INDEX [AGrName]
  ON [dbo].[r_AssetG] ([AGrName])
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [ChID]
  ON [dbo].[r_AssetG] ([ChID])
  ON [PRIMARY]
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_AssetG.ChID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_AssetG.AGrID'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_AssetG] ON [r_AssetG]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_AssetG', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_AssetG] ON [r_AssetG]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_AssetG', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_AssetG] ON [r_AssetG]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_AssetG', N'Last', N'DELETE'
GO