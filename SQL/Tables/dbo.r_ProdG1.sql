CREATE TABLE [dbo].[r_ProdG1] (
  ...
  CONSTRAINT [pk_r_ProdG1] PRIMARY KEY CLUSTERED ([PGrID1])
)
ON [PRIMARY]
GO

CREATE UNIQUE INDEX [ChID]
  ON [dbo].[r_ProdG1] ([ChID])
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [PGrName1]
  ON [dbo].[r_ProdG1] ([PGrName1])
  ON [PRIMARY]
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_ProdG1.ChID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_ProdG1.PGrID1'
GO
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_ProdG1', N'Last', N'UPDATE'
GO
