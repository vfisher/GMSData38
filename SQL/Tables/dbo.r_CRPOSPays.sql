CREATE TABLE [dbo].[r_CRPOSPays] (
  ...
  CONSTRAINT [pk_r_CRPosPays] PRIMARY KEY CLUSTERED ([WPID], [POSPayID])
)
ON [PRIMARY]
GO

CREATE INDEX [POSPayID]
  ON [dbo].[r_CRPOSPays] ([POSPayID])
  ON [PRIMARY]
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_CRPOSPays] ON [r_CRPOSPays]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_CRPOSPays', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_CRPOSPays] ON [r_CRPOSPays]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_CRPOSPays', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_CRPOSPays] ON [r_CRPOSPays]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_CRPOSPays', N'Last', N'DELETE'
GO