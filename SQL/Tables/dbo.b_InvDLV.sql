CREATE TABLE [dbo].[b_InvDLV] (
  ...
  CONSTRAINT [pk_b_InvDLV] PRIMARY KEY CLUSTERED ([ChID], [SrcPosID], [LevyID])
)
ON [PRIMARY]
GO
...
GO
CREATE TRIGGER [dbo].[TAU1_INS_b_InvDLV] ON [b_InvDLV]
FOR INSERT
AS
BEGIN
...
SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TAU2_UPD_b_InvDLV] ON [b_InvDLV]
FOR UPDATE
AS
BEGIN
  IF @@RowCount = 0 RETURN
...
SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TAU3_DEL_b_InvDLV] ON [b_InvDLV]
FOR DELETE
AS
BEGIN
  IF @@RowCount = 0 RETURN
...
SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_b_InvDLV] ON [b_InvDLV]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_b_InvDLV', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_b_InvDLV] ON [b_InvDLV]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_b_InvDLV', N'Last', N'UPDATE'
GO