CREATE TABLE [dbo].[r_Emps] (
  ...
  CONSTRAINT [pk_r_Emps] PRIMARY KEY CLUSTERED ([EmpID])
)
ON [PRIMARY]
GO

CREATE INDEX [CertInsurNum]
  ON [dbo].[r_Emps] ([CertInsurNum])
  ON [PRIMARY]
GO

CREATE INDEX [CertInsurSer]
  ON [dbo].[r_Emps] ([CertInsurSer])
  ON [PRIMARY]
GO
...
CREATE UNIQUE INDEX [EmpName]
  ON [dbo].[r_Emps] ([EmpName])
  ON [PRIMARY]
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_Emps.ChID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_Emps.EmpID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_Emps.EmpSex'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_Emps.Education'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_Emps.FamilyStatus'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_Emps.Percent1'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_Emps.Percent2'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_Emps.Percent3'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_Emps.MilStatus'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_Emps.MilFitness'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_Emps.InStopList'
GO
...
SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_Emps] ON [r_Emps]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_Emps', N'Last', N'UPDATE'
GO
