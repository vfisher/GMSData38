CREATE TABLE [dbo].[b_GTran] (
  ...
  CONSTRAINT [_pk_b_GTran] PRIMARY KEY CLUSTERED ([GTranID])
)
ON [PRIMARY]
GO

CREATE INDEX [GOperID]
  ON [dbo].[b_GTran] ([GOperID])
  ON [PRIMARY]
GO

CREATE INDEX [IntDocID]
  ON [dbo].[b_GTran] ([IntDocID])
  ON [PRIMARY]
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_GTran.GTranID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_GTran.GOperID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_GTran.DocCode'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_GTran.DocID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_GTran.OurID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_GTran.KursMC'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_b_GTran] ON [b_GTran]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_b_GTran', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_b_GTran] ON [b_GTran]
FOR UPDATE AS
