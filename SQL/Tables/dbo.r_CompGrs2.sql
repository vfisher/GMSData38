CREATE TABLE [dbo].[r_CompGrs2] (
  ...
  CONSTRAINT [pk_r_CompGrs2] PRIMARY KEY CLUSTERED ([CompGrID2])
)
ON [PRIMARY]
GO

CREATE UNIQUE INDEX [ChID]
  ON [dbo].[r_CompGrs2] ([ChID])
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [CompGrName2]
  ON [dbo].[r_CompGrs2] ([CompGrName2])
  ON [PRIMARY]
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_CompGrs2] ON [r_CompGrs2]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_CompGrs2', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_CompGrs2] ON [r_CompGrs2]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_CompGrs2', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_CompGrs2] ON [r_CompGrs2]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_CompGrs2', N'Last', N'DELETE'
GO