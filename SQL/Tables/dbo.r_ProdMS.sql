CREATE TABLE [dbo].[r_ProdMS] (
  ...
  CONSTRAINT [_pk_r_ProdMS] PRIMARY KEY CLUSTERED ([ProdID], [SProdID])
)
ON [PRIMARY]
GO

CREATE INDEX [EExp]
  ON [dbo].[r_ProdMS] ([EExp])
  ON [PRIMARY]
GO

CREATE INDEX [EExpSub]
  ON [dbo].[r_ProdMS] ([EExpSub])
  ON [PRIMARY]
GO

CREATE INDEX [ProdID]
  ON [dbo].[r_ProdMS] ([ProdID])
  ON [PRIMARY]
GO

CREATE INDEX [RExp]
  ON [dbo].[r_ProdMS] ([LExp])
  ON [PRIMARY]
GO

CREATE INDEX [RExpSub]
  ON [dbo].[r_ProdMS] ([LExpSub])
  ON [PRIMARY]
GO

CREATE INDEX [SProdID]
  ON [dbo].[r_ProdMS] ([SProdID])
  ON [PRIMARY]
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_ProdMS.ProdID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_ProdMS.SProdID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_ProdMS.UseSubItems'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_ProdMS.UseSubDoc'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_ProdMS] ON [r_ProdMS]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_ProdMS', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_ProdMS] ON [r_ProdMS]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_ProdMS', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_ProdMS] ON [r_ProdMS]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_ProdMS', N'Last', N'DELETE'
GO