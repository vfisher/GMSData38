CREATE TABLE [dbo].[r_Displays] (
  ...
  CONSTRAINT [pk_r_Displays] PRIMARY KEY CLUSTERED ([DisplayID], [WPID])
)
ON [PRIMARY]
GO

CREATE UNIQUE INDEX [UniqueIndex]
  ON [dbo].[r_Displays] ([WPID], [Port])
  ON [PRIMARY]
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_Displays] ON [r_Displays]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_Displays', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_Displays] ON [r_Displays]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_Displays', N'Last', N'UPDATE'
GO