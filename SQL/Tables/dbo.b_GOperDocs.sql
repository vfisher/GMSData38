CREATE TABLE [dbo].[b_GOperDocs] (
  ...
  CONSTRAINT [_pk_b_MapDO] PRIMARY KEY CLUSTERED ([ChID])
)
ON [PRIMARY]
GO

CREATE INDEX [GOperID]
  ON [dbo].[b_GOperDocs] ([GOperID])
  ON [PRIMARY]
GO

CREATE INDEX [GTAccID]
  ON [dbo].[b_GOperDocs] ([GTAccID])
  ON [PRIMARY]
GO

CREATE INDEX [GTaxAccID]
  ON [dbo].[b_GOperDocs] ([GTaxAccID])
  ON [PRIMARY]
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_GOperDocs.ChID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_GOperDocs.GOperID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_GOperDocs.GTAccID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_GOperDocs.GTaxAccID'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_b_GOperDocs] ON [b_GOperDocs]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_b_GOperDocs', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_b_GOperDocs] ON [b_GOperDocs]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_b_GOperDocs', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_b_GOperDocs] ON [b_GOperDocs]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_b_GOperDocs', N'Last', N'DELETE'
GO