CREATE TABLE [dbo].[z_WCopyFUF] (
  ...
  CONSTRAINT [_pk_z_WCopyFUF] PRIMARY KEY CLUSTERED ([AChID], [FieldPosID], [UserID])
)
ON [PRIMARY]
GO

CREATE INDEX [AChID]
  ON [dbo].[z_WCopyFUF] ([AChID])
  ON [PRIMARY]
GO

CREATE INDEX [FieldPosID]
  ON [dbo].[z_WCopyFUF] ([FieldPosID])
  ON [PRIMARY]
GO

CREATE INDEX [UserID]
  ON [dbo].[z_WCopyFUF] ([UserID])
  ON [PRIMARY]
GO

CREATE INDEX [z_WCopyFz_WCopyFUF]
  ON [dbo].[z_WCopyFUF] ([AChID], [FieldPosID])
  ON [PRIMARY]
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.z_WCopyFUF.AChID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.z_WCopyFUF.FieldPosID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.z_WCopyFUF.UserID'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_z_WCopyFUF] ON [z_WCopyFUF]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_z_WCopyFUF', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_z_WCopyFUF] ON [z_WCopyFUF]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_z_WCopyFUF', N'Last', N'UPDATE'
GO