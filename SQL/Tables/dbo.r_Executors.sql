CREATE TABLE [dbo].[r_Executors] (
  ...
  [EmpID] [int] NOT NULL,
  CONSTRAINT [pk_r_Executors] PRIMARY KEY CLUSTERED ([ExecutorID])
)
ON [PRIMARY]
GO

CREATE UNIQUE INDEX [ChID]
  ON [dbo].[r_Executors] ([ChID])
  ON [PRIMARY]
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_Executors] ON [r_Executors]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_Executors', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_Executors] ON [r_Executors]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_Executors', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_Executors] ON [r_Executors]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_Executors', N'Last', N'DELETE'
GO