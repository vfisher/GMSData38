CREATE TABLE [dbo].[z_WCopyF] (
  ...
  CONSTRAINT [_pk_z_WCopyF] PRIMARY KEY CLUSTERED ([AChID], [FieldPosID])
)
ON [PRIMARY]
GO

CREATE INDEX [AChID]
  ON [dbo].[z_WCopyF] ([AChID])
  ON [PRIMARY]
GO

CREATE INDEX [FieldName]
  ON [dbo].[z_WCopyF] ([FieldName])
  ON [PRIMARY]
GO

CREATE INDEX [FieldPosID]
  ON [dbo].[z_WCopyF] ([FieldPosID])
  ON [PRIMARY]
GO

CREATE INDEX [FieldSortPosID]
  ON [dbo].[z_WCopyF] ([FieldSortPosID])
  ON [PRIMARY]
GO

CREATE INDEX [FieldSuffix]
  ON [dbo].[z_WCopyF] ([FieldSuffix])
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [NoDuplicate]
  ON [dbo].[z_WCopyF] ([AChID], [FieldSortPosID])
  ON [PRIMARY]
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.z_WCopyF.AChID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.z_WCopyF.FieldPosID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.z_WCopyF.UserField'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.z_WCopyF.AskFilter'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.z_WCopyF.FieldSortPosID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.z_WCopyF.SortType'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_z_WCopyF] ON [z_WCopyF]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_z_WCopyF', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_z_WCopyF] ON [z_WCopyF]
FOR UPDATE AS
