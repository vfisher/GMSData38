CREATE TABLE [dbo].[b_SRep] (
  ...
  CONSTRAINT [pk_b_SRep] PRIMARY KEY CLUSTERED ([ChID])
)
ON [PRIMARY]
GO
...
CREATE INDEX [CompID]
  ON [dbo].[b_SRep] ([CompID])
  ON [PRIMARY]
GO

CREATE INDEX [DocDate]
  ON [dbo].[b_SRep] ([DocDate])
  ON [PRIMARY]
GO
...
CREATE INDEX [GTAccID]
  ON [dbo].[b_SRep] ([GTAccID])
  ON [PRIMARY]
GO

CREATE INDEX [IntDocID]
  ON [dbo].[b_SRep] ([IntDocID])
  ON [PRIMARY]
GO

CREATE INDEX [KursMC]
  ON [dbo].[b_SRep] ([KursMC])
  ON [PRIMARY]
GO
...
CREATE INDEX [RepType]
  ON [dbo].[b_SRep] ([RepType])
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [UniqueIndex]
  ON [dbo].[b_SRep] ([OurID], [DocID])
  ON [PRIMARY]
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_SRep.ChID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_SRep.DocID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_SRep.KursMC'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_SRep.OurID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_SRep.CompID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_SRep.EmpID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_SRep.AssID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_SRep.GTSum_wt'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_SRep.GTTaxSum'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_SRep.GTAccID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.b_SRep.RepType'
GO
...
SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_b_SRep] ON [b_SRep]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_b_SRep', N'Last', N'UPDATE'
GO
