CREATE TABLE [dbo].[r_ProdCV] (
  ...
  CONSTRAINT [_pk_r_ProdCV] PRIMARY KEY CLUSTERED ([ProdID], [CompID], [BDate])
)
ON [PRIMARY]
GO

CREATE INDEX [CompID]
  ON [dbo].[r_ProdCV] ([CompID])
  ON [PRIMARY]
GO

CREATE INDEX [ProdID]
  ON [dbo].[r_ProdCV] ([ProdID])
  ON [PRIMARY]
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_ProdCV.ProdID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_ProdCV.CompID'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_ProdCV.Value1'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_ProdCV.Value2'
GO

EXEC sp_bindefault @defname = N'dbo.DF_Zero', @objname = N'dbo.r_ProdCV.Value3'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_ProdCV] ON [r_ProdCV]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_ProdCV', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_ProdCV] ON [r_ProdCV]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_ProdCV', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_ProdCV] ON [r_ProdCV]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_ProdCV', N'Last', N'DELETE'
GO