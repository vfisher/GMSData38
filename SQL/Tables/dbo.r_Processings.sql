CREATE TABLE [dbo].[r_Processings] (
  ...
  CONSTRAINT [pk_r_Processings] PRIMARY KEY CLUSTERED ([ProcessingID])
)
ON [PRIMARY]
GO

CREATE UNIQUE INDEX [ChID]
  ON [dbo].[r_Processings] ([ChID])
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [ProcessingName]
  ON [dbo].[r_Processings] ([ProcessingName])
  ON [PRIMARY]
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_Processings] ON [r_Processings]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_Processings', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_Processings] ON [r_Processings]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_Processings', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_Processings] ON [r_Processings]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_Processings', N'Last', N'DELETE'
GO