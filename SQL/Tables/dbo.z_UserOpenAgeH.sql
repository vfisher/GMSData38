CREATE TABLE [dbo].[z_UserOpenAgeH] (
  ...
  CONSTRAINT [pk_z_UserOpenAgeH] PRIMARY KEY CLUSTERED ([OurID], [UserID], [ChDate])
)
ON [PRIMARY]
GO
...
GO
CREATE TRIGGER [dbo].[TRel1_Ins_z_UserOpenAgeH] ON [z_UserOpenAgeH]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_z_UserOpenAgeH', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_z_UserOpenAgeH] ON [z_UserOpenAgeH]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_z_UserOpenAgeH', N'Last', N'UPDATE'
GO