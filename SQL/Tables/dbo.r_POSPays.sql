...
CREATE UNIQUE INDEX [ChID]
  ON [dbo].[r_POSPays] ([ChID])
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [POSPayName]
  ON [dbo].[r_POSPays] ([POSPayName])
  ON [PRIMARY]
GO
...
SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_POSPays] ON [r_POSPays]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_POSPays', N'Last', N'UPDATE'
GO
