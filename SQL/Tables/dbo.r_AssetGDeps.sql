CREATE TABLE [dbo].[r_AssetGDeps] (
  ...
  CONSTRAINT [pk_r_AssetGDeps] PRIMARY KEY CLUSTERED ([AGrID], [DocDate])
)
ON [PRIMARY]
GO
...
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_AssetGDeps] ON [r_AssetGDeps]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_AssetGDeps', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_AssetGDeps] ON [r_AssetGDeps]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_AssetGDeps', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_AssetGDeps] ON [r_AssetGDeps]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_AssetGDeps', N'Last', N'DELETE'
GO