CREATE TABLE [dbo].[r_Countries] (
  ...
  CONSTRAINT [pk_r_Countries] PRIMARY KEY CLUSTERED ([CounID])
)
ON [PRIMARY]
GO

CREATE UNIQUE INDEX [ChID]
  ON [dbo].[r_Countries] ([ChID])
  ON [PRIMARY]
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_Countries] ON [r_Countries]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_Countries', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_Countries] ON [r_Countries]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_Countries', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_Countries] ON [r_Countries]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_Countries', N'Last', N'DELETE'
GO