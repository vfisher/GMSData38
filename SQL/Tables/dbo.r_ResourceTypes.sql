CREATE TABLE [dbo].[r_ResourceTypes] (
  ...
  CONSTRAINT [pk_r_ResourceTypes] PRIMARY KEY CLUSTERED ([ResourceTypeID])
)
ON [PRIMARY]
GO

CREATE UNIQUE INDEX [ChID]
  ON [dbo].[r_ResourceTypes] ([ChID])
  ON [PRIMARY]
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_ResourceTypes] ON [r_ResourceTypes]
FOR INSERT AS
...
EXEC sp_settriggerorder N'dbo.TRel1_Ins_r_ResourceTypes', N'Last', N'INSERT'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_ResourceTypes] ON [r_ResourceTypes]
FOR UPDATE AS
...
EXEC sp_settriggerorder N'dbo.TRel2_Upd_r_ResourceTypes', N'Last', N'UPDATE'
GO

SET QUOTED_IDENTIFIER, ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_ResourceTypes] ON [r_ResourceTypes]
FOR DELETE AS
...
EXEC sp_settriggerorder N'dbo.TRel3_Del_r_ResourceTypes', N'Last', N'DELETE'
GO