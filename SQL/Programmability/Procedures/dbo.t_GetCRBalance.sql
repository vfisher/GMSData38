...
BEGIN
  ...
  SELECT m.ChID, m.DocID, m.OurID, m.DocDate, TSumCC_wt, dbo.zf_GetTaxPayerByDate(m.OurID, m.DocDate) AS TaxPayerByDate, m.SaleRndSum, TSumCC_wt AS SaleNoRndSum, m.TPurSumCC_wt   
  INTO #t_Sale
  ...
  SELECT m.ChID, m.DocID, m.OurID, m.DocDate, TSumCC_wt, dbo.zf_GetTaxPayerByDate(m.OurID, m.SrcDocDate) AS TaxPayerByDate, m.RetRndSum, TSumCC_wt AS RetNoRndSum  
  INTO #t_CRRet
