...
SET ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TGMSRel2_Upd_t_SaleTemp] ON [dbo].[t_SaleTemp]
FOR UPDATE AS
...
SET ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TGMSRel3_Del_t_SaleTemp] ON [dbo].[t_SaleTemp]
FOR DELETE AS
...
SET ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_t_SaleTemp] ON [dbo].[t_SaleTemp]
FOR INSERT AS
...
END
GO
EXEC sp_settriggerorder N'[dbo].[TRel1_Ins_t_SaleTemp]', 'last', 'insert', null
GO
SET QUOTED_IDENTIFIER ON
GO
SET ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_t_SaleTemp] ON [dbo].[t_SaleTemp]
FOR UPDATE AS
/* t_SaleTemp - Временные данные продаж: Заголовок - UPDATE TRIGGER */
BEGIN
  DECLARE @RCount Int
...
END
GO
EXEC sp_settriggerorder N'[dbo].[TRel2_Upd_t_SaleTemp]', 'last', 'update', null
GO
SET QUOTED_IDENTIFIER ON
GO
SET ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_t_SaleTemp] ON [dbo].[t_SaleTemp]
FOR DELETE AS
/* t_SaleTemp - Временные данные продаж: Заголовок - DELETE TRIGGER */
BEGIN
  SET NOCOUNT ON
...
END
GO
EXEC sp_settriggerorder N'[dbo].[TRel3_Del_t_SaleTemp]', 'last', 'delete', null
GO
