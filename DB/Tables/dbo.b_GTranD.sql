...
SET ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_b_GTranD] ON [dbo].[b_GTranD]
FOR INSERT AS
...
END
GO
EXEC sp_settriggerorder N'[dbo].[TRel1_Ins_b_GTranD]', 'last', 'insert', null
GO
SET QUOTED_IDENTIFIER ON
GO
SET ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_b_GTranD] ON [dbo].[b_GTranD]
FOR UPDATE AS
...
END
GO
EXEC sp_settriggerorder N'[dbo].[TRel2_Upd_b_GTranD]', 'last', 'update', null
GO
