...
SET ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_z_WCopyDV] ON [dbo].[z_WCopyDV]
FOR INSERT AS
...
END
GO
EXEC sp_settriggerorder N'[dbo].[TRel1_Ins_z_WCopyDV]', 'last', 'insert', null
GO
SET QUOTED_IDENTIFIER ON
GO
SET ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_z_WCopyDV] ON [dbo].[z_WCopyDV]
FOR UPDATE AS
...
END
GO
EXEC sp_settriggerorder N'[dbo].[TRel2_Upd_z_WCopyDV]', 'last', 'update', null
GO
