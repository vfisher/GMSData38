...
SET ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_z_UserProdG] ON [dbo].[z_UserProdG]
FOR INSERT AS
...
/* Доступные значения - Справочник товаров: 2 группа ^ Справочник товаров: 2 группа - Проверка в PARENT */
...
END
GO
EXEC sp_settriggerorder N'[dbo].[TRel1_Ins_z_UserProdG]', 'last', 'insert', null
GO
SET QUOTED_IDENTIFIER ON
GO
SET ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_z_UserProdG] ON [dbo].[z_UserProdG]
FOR UPDATE AS
...
END
GO
EXEC sp_settriggerorder N'[dbo].[TRel2_Upd_z_UserProdG]', 'last', 'update', null
GO
