...
SET ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_v_UParams] ON [dbo].[v_UParams]
FOR INSERT AS
...
END
GO
EXEC sp_settriggerorder N'[dbo].[TRel1_Ins_v_UParams]', 'last', 'insert', null
GO
SET QUOTED_IDENTIFIER ON
GO
SET ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_v_UParams] ON [dbo].[v_UParams]
FOR UPDATE AS
...
END
GO
EXEC sp_settriggerorder N'[dbo].[TRel2_Upd_v_UParams]', 'last', 'update', null
GO
