...
SET ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_OursTaxPayerPeriod] ON [dbo].[r_OursTaxPayerPeriod]
FOR INSERT AS
...
END
GO
EXEC sp_settriggerorder N'[dbo].[TRel1_Ins_r_OursTaxPayerPeriod]', 'last', 'insert', null
GO
SET QUOTED_IDENTIFIER ON
GO
SET ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_OursTaxPayerPeriod] ON [dbo].[r_OursTaxPayerPeriod]
FOR UPDATE AS
...
End
GO
EXEC sp_settriggerorder N'[dbo].[TRel2_Upd_r_OursTaxPayerPeriod]', 'last', 'update', null
GO
SET QUOTED_IDENTIFIER ON
GO
SET ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_r_OursTaxPayerPeriod] ON [dbo].[r_OursTaxPayerPeriod]
FOR DELETE AS
...
END
GO
EXEC sp_settriggerorder N'[dbo].[TRel3_Del_r_OursTaxPayerPeriod]', 'last', 'delete', null
GO
