...
SET ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_r_DiscMessages] ON [dbo].[r_DiscMessages]
FOR INSERT AS
...
END
GO
EXEC sp_settriggerorder N'[dbo].[TRel1_Ins_r_DiscMessages]', 'last', 'insert', null
GO
SET QUOTED_IDENTIFIER ON
GO
SET ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_r_DiscMessages] ON [dbo].[r_DiscMessages]
FOR UPDATE AS
...
END
GO
EXEC sp_settriggerorder N'[dbo].[TRel2_Upd_r_DiscMessages]', 'last', 'update', null
GO
