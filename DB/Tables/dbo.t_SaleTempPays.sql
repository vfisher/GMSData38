...
SET ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel1_Ins_t_SaleTempPays] ON [dbo].[t_SaleTempPays]
FOR INSERT AS
...
END
GO
EXEC sp_settriggerorder N'[dbo].[TRel1_Ins_t_SaleTempPays]', 'last', 'insert', null
GO
SET QUOTED_IDENTIFIER ON
GO
SET ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel2_Upd_t_SaleTempPays] ON [dbo].[t_SaleTempPays]
FOR UPDATE AS
...
End
GO
EXEC sp_settriggerorder N'[dbo].[TRel2_Upd_t_SaleTempPays]', 'last', 'update', null
GO
SET QUOTED_IDENTIFIER ON
GO
SET ANSI_NULLS ON
GO
CREATE TRIGGER [dbo].[TRel3_Del_t_SaleTempPays] ON [dbo].[t_SaleTempPays]
FOR DELETE AS
...
END
GO
EXEC sp_settriggerorder N'[dbo].[TRel3_Del_t_SaleTempPays]', 'last', 'delete', null
GO
ALTER TABLE [dbo].[t_SaleTempPays] ADD CONSTRAINT [pk_t_SaleTempPays] PRIMARY KEY CLUSTERED ([ChID], [SrcPosID]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [ChID_PayFormCode_SumCC_wt] ON [dbo].[t_SaleTempPays] ([ChID], [PayFormCode], [SumCC_wt]) ON [PRIMARY]
GO
